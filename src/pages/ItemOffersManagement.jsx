          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate(-1)}
                className="bg-white/80 backdrop-blur-md rounded-full p-2 sm:p-3 text-[#F18E02] hover:bg-[#F18E02] hover:text-white transition-all duration-300 shadow-lg border border-[#F18E02] dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#F18E02]"
              >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl bg-white text-black focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-sm sm:text-base dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                />
              </div>
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                <motion.button
                  ...
                  className="flex items-center gap-2 bg-[#F18E02] text-white px-4 sm:px-5 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base whitespace-nowrap w-full sm:w-auto justify-center"
                >
            ...
            >
              ...
              {loadingPage && (
                <div className="flex justify-center items-center py-12">
                  <div className="flex flex-col items-center gap-4">
                    <div className="animate-spin rounded-full h-12 w-12 border-t-4 border-b-4 border-[#F18E02]"></div>
                  </div>
                </div>
              )}
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-start justify-between mb-3 sm:mb-4">
                            <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                              ...
                              >
                                {offer.isPercentage ? (
                                  <FaPercent className="text-[#F18E02] text-lg sm:text-xl" />
                                ) : (
                                  <FaMoneyBillWave className="text-[#F18E02] text-lg sm:text-xl" />
                                )}
                              </div>
                                  ...
                                  <div>
                                    ...
                                    <p className="font-bold text-blue-600 dark:text-blue-400 text-2xl">
                                      {offer.menuItem?.basePrice === 0 ? (
                                        <span className="text-[#F18E02] dark:text-[#F18E02] font-bold">
                                          حسب الطلب
                                        </span>
                                      ) : (
                                        `ج.م ${
                            ...
                            offer.branchNames.length > 0 ? (
                              <div className="flex flex-wrap gap-2">
                                {offer.branchNames.map((branchName, index) => (
                                  <span
                                    key={index}
                                    className="px-3 py-1.5 bg-[#F18E02] text-white rounded-lg text-xs font-medium flex items-center gap-1"
                                  >
              ...
              {!loading && !loadingPage && filteredOffers.length === 0 && (
                ...
                >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={handleAddNewOffer}
                    className="flex items-center gap-2 bg-[#F18E02] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base mx-auto"
                  >
                          ...
                          {pageNum === "..." ? (
                            ...
                            <button
                              ...
                              className={`px-3 sm:px-4 py-1 sm:py-2 rounded-xl font-semibold ${
                                currentPage === pageNum
                                  ? "bg-[#F18E02] text-white shadow-lg"
                                  : "bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-600"
                ...
                >
                  <div className="bg-white/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-4 sm:p-5 lg:p-6 border border-gray-200/50 dark:bg-gray-800/90 dark:border-gray-600 sticky top-4 sm:top-6 transition-colors duration-300">
                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                      ...
                      <button
                        onClick={resetForm}
                        className="text-gray-500 hover:text-[#F18E02] dark:text-gray-400 dark:hover:text-[#F18E02] transition-colors duration-200 flex-shrink-0 ml-2"
                      >
                    ...
                    >
                      <div>
                        ...
                        <div className="relative">
                          <button
                            ...
                            className="w-full flex items-center justify-between border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed text-right"
                          >
                            <span className="flex items-center gap-2 truncate">
                              <FaHamburger className="text-[#F18E02] flex-shrink-0" />
                              {formData.menuItemId
                                ? (() => {
                            ...
                            >
                              {loadingItems ? (
                                <FaSpinner className="text-[#F18E02] animate-spin" />
                              ) : (
                              ...
                              >
                                {loadingItems ? (
                                  <div className="flex items-center justify-center py-4">
                                    <FaSpinner className="text-[#F18E02] animate-spin text-lg" />
                        ...
                        <div>
                          ...
                          <div className="relative group">
                            {formData.isPercentage ? (
                              <FaPercent className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm" />
                            ) : (
                              <FaMoneyBillWave className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm" />
                            )}
                            <input
                              type="number"
                              name="discountValue"
                              ...
                              className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl pl-3 pr-9 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-sm sm:text-base text-right"
                              placeholder={
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                          ...
                          <div className="relative group">
                            <FaCalendarAlt className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm" />
                            <input
                              type="date"
                              name="startDate"
                              ...
                              onChange={handleInputChange}
                              required
                              className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl pl-3 pr-9 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-sm sm:text-base"
                            />
                          </div>
                        </div>
                        <div>
                          ...
                          <div className="relative group">
                            <FaClock className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm" />
                            <input
                              type="time"
                              name="startTime"
                              ...
                              {branches.map((branch) => (
                                ...
                                >
                                  <input
                                    ...
                                    className="text-[#F18E02] focus:ring-[#F18E02] rounded"
                                  />
                      ...
                      <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-[#fff5f5] to-[#ffe5e5] dark:from-gray-700 dark:to-gray-600 rounded-xl border border-[#F18E02]/30 dark:border-gray-500">
                        <input
                          type="checkbox"
                          name="isEnabled"
                          checked={formData.isEnabled}
                          onChange={handleInputChange}
                          className="w-4 h-4 text-[#F18E02] bg-gray-100 border-gray-300 rounded focus:ring-[#F18E02] focus:ring-2"
                        />
                      ...
                      <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2 flex-col sm:flex-row">
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          onClick={resetForm}
                          className="flex-1 py-2.5 sm:py-3 border-2 border-[#F18E02] text-[#F18E02] rounded-lg sm:rounded-xl font-semibold hover:bg-[#F18E02] hover:text-white transition-all duration-300 text-sm sm:text-base"
                        >
                          إلغاء
                        </motion.button>
                        <motion.button
