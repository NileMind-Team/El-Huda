...
export default function Cart() {
  ...
  const formatPriceDisplay = (product) => {
    if (product.isPriceBasedOnRequest) {
      return (
        <div className="text-[#F18E02] font-bold text-base sm:text-lg">
          السعر حسب الطلب
        </div>
      );
    }
    ...
    if (product.hasDiscount) {
      return (
        <>
          ...
          <span className="text-[#F18E02] font-bold text-base sm:text-lg">
  ...
  const formatPriceInModal = (product) => {
    if (product.basePrice === 0) {
      return (
        <span className="text-base sm:text-xl font-bold text-[#F18E02]">
          السعر حسب الطلب
        </span>
      );
    }
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <button
                ...
                className="bg-[#F18E02] text-white px-4 py-2 rounded-lg font-semibold text-sm hover:shadow-lg transition-all flex items-center gap-2 border border-[#F18E02]"
              >
                <FaPlusCircle />
                إضافة عنوان جديد
              </button>
      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <button
            ...
            className="text-[#F18E02] text-sm font-semibold hover:underline flex items-center gap-1"
          >
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 flex items-center justify-center px-3 sm:px-4 py-4 sm:py-8 transition-colors duration-300">
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-3 sm:px-4 py-4 sm:py-8 transition-colors duration-300">
        {/* Phone Input Modal */}
        {showPhoneInputModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[80] p-4">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <FaPhone className="text-[#F18E02] text-xl" />
              ...
              <div className="mb-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-[#F18E02] focus:border-transparent"
                    dir="ltr"
                  />
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-[#F18E02] text-white rounded-lg font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 border border-[#F18E02]"
                >
                  {loadingProfile ? (
                    <>
        ...
        {showMissingInfoModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[70] p-4">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <FaInfoCircle className="text-[#F18E02] text-xl" />
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white">
                    معلومات ناقصة
                  </h3>
                </div>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <motion.button
                    ...
                    className="w-full p-4 bg-white dark:bg-gray-700 rounded-xl border-2 border-gray-300 hover:border-[#F18E02] transition-all duration-300 flex items-center justify-center gap-3"
                  >
                  ...
                  >
                    <div className="w-12 h-12 bg-gray-100 dark:bg-gray-600 rounded-full flex items-center justify-center">
                      <FaMapPin className="text-[#F18E02] text-xl" />
                    </div>
                    <div className="text-right">
                      <h4 className="font-bold text-gray-800 dark:text-white text-base">
                        إضافة عنوان
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-[#F18E02] text-white rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center gap-2 border border-[#F18E02]"
                >
                  مواصلة التسوق
                </button>
              </div>
        ...
        {showNotesModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60] p-4">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  <FaStickyNote className="text-[#F18E02] text-xl" />
                  <h3 className="text-xl font-bold text-gray-800 dark:text-white">
                    تعليمات إضافية
                  </h3>
                </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3 mt-1 sm:mt-2">
                      ...
                      {productDetails.itemOffer?.isEnabled &&
                        ...
                        checkIfOfferValidForBranch(
                          ...
                          <div className="bg-[#F18E02] text-white px-2 py-1 sm:px-3 sm:py-1.5 rounded-md sm:rounded-lg font-bold shadow text-xs sm:text-sm flex items-center gap-1 border border-white">
                            <span>خصم</span>
                            <span>
                              {toArabicNumbers(
                ...
                <div className="flex flex-wrap items-center gap-3 sm:gap-4 mb-4 sm:mb-5">
                  {productDetails.calories && (
                    <span className="flex items-center gap-1 text-gray-600 dark:text-gray-400 text-xs sm:text-sm">
                      <FaFire className="text-[#F18E02] text-xs sm:text-sm" />
                              ...
                              return (
                                <motion.button
                                  ...
                                  className={`w-full p-2 rounded-md sm:rounded-lg border-2 transition-all duration-200 flex items-center justify-between ${
                                    isSelected
                                      ? "border-[#F18E02] bg-red-50 dark:bg-red-900/20"
                                ...
                                >
                                  <div className="flex items-center gap-1">
                                    ...
                                    {isSelected && (
                                      <FaCheck className="text-[#F18E02] text-xs" />
                                    )}
                                  </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-3 sm:gap-4">
                  ...
                  <div className="flex items-center justify-between w-full md:w-auto gap-3 sm:gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center bg-white dark:bg-gray-700 rounded-lg p-1 shadow border border-gray-300">
                        ...
                        >
                          <FaMinus className="text-[#F18E02] text-xs" />
                        </button>
                        ...
                        <button
                          ...
                          className="w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 flex items-center justify-center rounded-md hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors border border-gray-200"
                        >
                          <FaPlus className="text-[#F18E02] text-xs" />
                        </button>
                      </div>
                    </div>
                    <div className="text-base sm:text-lg lg:text-xl font-bold text-[#F18E02]">
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 w-full md:w-auto">
                    ...
                    <motion.button
                      ...
                      className="flex-1 md:flex-none px-4 py-2 bg-[#F18E02] text-white rounded-lg font-semibold hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm border border-[#F18E02]"
                    >
                      {updatingCart ? (
                        <>
                          <div className="animate-spin rounded-full h-4 w-4 border-t-2 border-b-2 border-white"></div>
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate(-1)}
                className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-full p-2 sm:p-3 text-[#F18E02] dark:text-gray-300 hover:bg-[#F18E02] hover:text-white transition-all duration-300 shadow-lg border border-gray-300"
              >
            ...
            <div className="text-right self-end sm:self-auto">
              <div className="text-lg sm:text-xl md:text-2xl font-bold text-[#F18E02]">
            ...
            <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              ...
              >
                <h2 className="text-xl sm:text-2xl font-bold text-gray-800 dark:text-white mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
                  <FaShoppingCart
                    className="text-[#F18E02] sm:w-6 sm:h-6"
                    size={18}
                  />
                  ...
                  <AnimatePresence>
                    {cartItems.length === 0 ? (
                      <div className="text-center py-8 sm:py-12 bg-white dark:bg-gray-700 rounded-xl sm:rounded-2xl border border-gray-300 dark:border-gray-600">
                        ...
                        <button
                          onClick={() => navigate("/")}
                          className="bg-[#F18E02] text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all text-sm sm:text-base border border-[#F18E02]"
                        >
                          تصفح المنتجات
                        </button>
                      </div>
                          ...
                          <div className="flex gap-3 sm:gap-4 w-full sm:w-auto sm:flex-1">
                            <div className="relative">
                              ...
                              {item.hasDiscount &&
                                !item.isPriceBasedOnRequest && (
                                  <div className="absolute -top-2 -right-2 bg-[#F18E02] text-white px-2 py-1 rounded-lg text-xs font-bold shadow-lg border border-white">
                                    خصم{" "}
                                    {toArabicNumbers(
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="mb-1 sm:mb-2">
                                <div className="flex items-center gap-2">
                                  <h3 className="font-bold text-gray-800 dark:text-white text-base sm:text-lg group-hover:text-[#F18E02] transition-colors">
                                    {item.name}
                                  </h3>
                                  <FaInfoCircle className="text-[#F18E02] opacity-0 group-hover:opacity-100 transition-opacity" />
                                </div>
                              </div>
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1 sm:gap-2 bg-white dark:bg-gray-700 rounded-lg sm:rounded-xl p-1 sm:p-2 shadow-lg border border-gray-300">
                              <button
                                ...
                                className="w-6 h-6 sm:w-8 sm:h-8 flex items-center justify-center rounded-md sm:rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200 text-[#F18E02] border border-gray-200"
                              >
              ...
              >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <FaMapMarkerAlt className="text-[#F18E02] text-lg" />
                      </div>
                    </div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <FaStore className="text-[#F18E02] text-lg" />
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  {loadingBranches ? (
                    ...
                    <div className="relative">
                      <button
                        ...
                        className="w-full flex items-center justify-between border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-sm sm:text-base cursor-pointer"
                      >
                        <span className="flex items-center gap-2">
                          <FaStore className="text-[#F18E02]" />
                        ...
                        >
                          <FaChevronDown className="text-[#F18E02]" />
                        </motion.div>
                      </button>
                    ...
                    >
                      ...
                      {loadingAreas ? (
                        ...
                        <div className="relative">
                          ...
                          >
                            <span className="flex items-center gap-2">
                              <FaMapMarkerAlt className="text-[#F18E02]" />
                              {selectedArea
                ...
                <div className="mt-4 sm:mt-6">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg sm:rounded-xl dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-[#F18E02] focus:border-transparent resize-none h-32"
                    dir="rtl"
                    maxLength={500}
                  />
            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <div className="mb-4 sm:mb-6">
                  <div className="bg-white dark:bg-gray-700 rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-gray-300 dark:border-gray-600">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-8 h-8 bg-[#F18E02] rounded-full flex items-center justify-center border border-[#F18E02]">
                    ...
                    <div className="text-sm">
                      {deliveryType === "delivery" && selectedAddress ? (
                        ...
                        <div className="text-[#F18E02] text-sm">
                ...
                <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                  ...
                  <div className="border-t border-gray-300 dark:border-gray-600 pt-3 sm:pt-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-bold text-[#F18E02] text-lg sm:text-xl md:text-2xl">
                      ...
                      {deliveryType === "delivery" && selectedArea && (
                        <>
                          ...
                          <div className="flex justify-between text-xs sm:text-sm">
                            ...
                            <span className="font-semibold text-[#F18E02]">
                              {getDeliveryFee().toFixed(2)} ج.م
                            </span>
                          </div>
                        </>
                ...
                <motion.button
                  ...
                  className={`w-full py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg shadow-lg transition-all duration-300 flex items-center justify-center gap-2 border ${
                    ...
                    (deliveryType === "delivery" && !selectedAddress)
                      ...
                      : "bg-[#F18E02] text-white hover:shadow-xl border-[#F18E02]"
                  }`}
                >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={() => navigate("/")}
                  className="w-full mt-3 sm:mt-4 border-2 border-[#F18E02] text-[#F18E02] py-2 sm:py-3 rounded-xl sm:rounded-2xl font-semibold text-sm sm:text-base hover:bg-[#F18E02] hover:text-white transition-all duration-300"
                >
                  مواصلة التسوق
                </motion.button>
              </motion.div>
