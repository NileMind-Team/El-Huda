...
export default function AdminUsers() {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] px-4">
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] px-3 sm:px-4 md:px-6 py-3 sm:py-6 relative font-sans overflow-hidden transition-colors duration-300`}
        style={{ direction: "rtl" }}
      >
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -left-10 sm:-left-20 -top-10 sm:-top-20 w-40 h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-gradient-to-r from-[#F18E02]/10 to-transparent rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
          <div className="absolute -right-10 sm:-right-20 -bottom-10 sm:-bottom-20 w-40 h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-gradient-to-r from-transparent to-[#F18E02]/10 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
        </div>
        ...
        <motion.button
          ...
          onClick={() => navigate(-1)}
          className="fixed top-3 sm:top-4 left-3 sm:left-4 z-50 bg-white/80 backdrop-blur-md hover:bg-[#F18E02] hover:text-white rounded-full p-2 sm:p-3 text-[#F18E02] border-2 border-[#F18E02] shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl group"
        >
          <FaArrowLeft
            size={14}
