            ...
            {!loading && message ? (
              ...
              <>
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-bold bg-gradient-to-r from-[#E41E26] to-[#000000] bg-clip-text text-transparent">
                ...
                <form onSubmit={handleResetPassword} className="space-y-6">
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl pl-12 pr-12 py-4 outline-none focus:ring-2 focus:ring-[#E41E26] focus:border-transparent transition-all duration-200 group-hover:border-[#E41E26]/50"
                    />
                  ...
                  <motion.button
                    ...
                    className={`w-full font-semibold py-4 rounded-xl transition-all duration-300 text-lg relative overflow-hidden ${
                      isFormValid
                        ? "bg-[#E41E26] text-white hover:shadow-xl hover:shadow-[#E41E26]/25 hover:bg-[#d11c24] border border-[#E41E26]"
