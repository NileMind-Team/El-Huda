...
export default function ResetPassword() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-4 relative font-sans overflow-hidden transition-colors duration-300">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -left-20 -top-20 w-80 h-80 bg-gradient-to-r from-[#F18E02]/10 to-[#000000]/10 dark:from-[#F18E02]/20 dark:to-[#000000]/20 rounded-full blur-3xl"></div>
          <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-gradient-to-r from-[#000000]/10 to-[#F18E02]/10 dark:from-[#000000]/20 dark:to-[#F18E02]/20 rounded-full blur-3xl"></div>
        </div>
        ...
        >
          <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-[#F18E02]/5 to-transparent rounded-bl-3xl"></div>
          ...
          <div className="p-8">
            {!loading && message ? (
              <div className="flex flex-col items-center justify-center py-8 space-y-6">
                ...
                <h2 className="text-2xl font-bold bg-gradient-to-r from-[#F18E02] to-[#000000] bg-clip-text text-transparent text-center">
                  {success
                    ? "تم إعادة تعيين كلمة المرور بنجاح"
                    : "فشل إعادة التعيين"}
                </h2>
                ...
                {success && (
                  <motion.button
                    ...
                    className="mt-4 bg-[#F18E02] text-white px-8 py-3 rounded-xl font-semibold hover:shadow-xl hover:shadow-[#F18E02]/25 transition-all duration-300 hover:bg-[#be6f00] border border-[#F18E02]"
                  >
              ...
              <>
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-bold bg-gradient-to-r from-[#F18E02] to-[#000000] bg-clip-text text-transparent">
                ...
                <form onSubmit={handleResetPassword} className="space-y-6">
                  <div className="relative group">
                    <div className="absolute inset-y-0 left-0 flex items-center justify-center pl-4">
                      <FaLock className="text-[#F18E02] text-lg transition-all duration-300 group-focus-within:scale-110" />
                    </div>
                    <input
                      ...
                      className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-black dark:text-white rounded-xl pl-12 pr-12 py-4 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 group-hover:border-[#F18E02]/50"
                    />
                    <div className="absolute inset-y-0 right-0 flex items-center justify-center pr-4">
                      <div
                        onClick={() => setShowPassword(!showPassword)}
                        className="text-gray-500 dark:text-gray-400 hover:text-[#F18E02] cursor-pointer transition-all duration-200 hover:scale-110"
                      >
                        {showPassword ? (
                          <FaEyeSlash size={18} />
                        ) : (
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-600 space-y-2 transition-colors duration-300">
                    <p className="text-sm font-semibold text-[#F18E02]">
                      متطلبات كلمة المرور:
                    </p>
                  ...
                  <motion.button
                    ...
                    className={`w-full font-semibold py-4 rounded-xl transition-all duration-300 text-lg relative overflow-hidden ${
                      isFormValid
                        ? "bg-[#F18E02] text-white hover:shadow-xl hover:shadow-[#F18E02]/25 hover:bg-[#be6f00] border border-[#F18E02]"
                ...
                <div className="flex space-x-2 justify-center mt-8">
                  <div className="w-3 h-3 bg-[#F18E02] rounded-full animate-bounce"></div>
                  <div
                    className="w-3 h-3 bg-[#000000] rounded-full animate-bounce"
                    style={{ animationDelay: "0.2s" }}
                  ></div>
                  <div
                    className="w-3 h-3 bg-[#F18E02] rounded-full animate-bounce"
