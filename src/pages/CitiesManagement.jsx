...
const showMessage = (type, title, text, options = {}) => {
  if (isMobile() && !options.forceSwal) {
    ...
    Swal.fire({
      ...
      title: title,
      text: text,
      confirmButtonColor: options.confirmButtonColor || "#F18E02", // Updated: Red color
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate(-1)}
                className="bg-white dark:bg-gray-800 rounded-full p-2 sm:p-3 text-[#F18E02] hover:bg-[#F18E02] hover:text-white transition-all duration-300 shadow-lg border border-gray-300 dark:border-gray-600"
              >
          ...
          >
            <div className="flex justify-end">
              <motion.button
                ...
                className="flex items-center gap-2 bg-[#F18E02] text-white px-4 sm:px-5 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl hover:bg-[#be6f00] transition-all duration-300 text-sm sm:text-base whitespace-nowrap border border-[#F18E02]"
              >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                              <div className="p-2 sm:p-3 bg-gray-100 dark:bg-gray-700 rounded-xl sm:rounded-2xl border border-gray-300 dark:border-gray-500">
                                <FaCity className="text-[#F18E02] dark:text-[#F18E02] text-lg sm:text-xl" />
                              </div>
                  ...
                  {filteredCities.length === 0 && (
                    ...
                    >
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={handleAddNewCity}
                        className="flex items-center gap-2 bg-[#F18E02] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold shadow-lg hover:shadow-xl hover:bg-[#be6f00] transition-all duration-300 text-sm sm:text-base mx-auto border border-[#F18E02]"
                      >
                ...
                >
                  <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-4 sm:p-5 lg:p-6 border border-gray-300 dark:border-gray-600 sticky top-4 sm:top-6 transition-colors duration-300">
                    <div className="flex items-center justify-between mb-3 sm:mb-4">
                      ...
                      <button
                        onClick={resetForm}
                        className="text-gray-500 hover:text-[#F18E02] dark:text-gray-400 dark:hover:text-[#F18E02] transition-colors duration-200 flex-shrink-0 ml-2 border border-gray-300 dark:border-gray-600 p-1 rounded-full"
                      >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          <FaCity className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm transition-all duration-300 group-focus-within:scale-110" />
                          <input
                            type="text"
                            name="name"
                            value={formData.name}
                            ...
                            required
                            className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl pl-9 pr-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-sm sm:text-base"
                      ...
                      <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2">
                        ...
                        <motion.button
                          ...
                          className={`flex-1 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold transition-all duration-300 text-sm sm:text-base flex items-center justify-center gap-1 sm:gap-2 ${
                            isFormValid()
                              ? "bg-[#F18E02] text-white hover:bg-[#be6f00] hover:shadow-xl cursor-pointer border border-[#F18E02]"
