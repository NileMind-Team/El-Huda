...
export default function AuthPage() {
  ...
  const translateSocialError = (error) => {
    ...
    return errorMap[error] || "حدث خطأ أثناء تسجيل الدخول باستخدام حساب Google";
  };
      ...
      >
        {showWelcome ? (
          ...
          <div className="flex flex-col items-center justify-center min-h-[400px]">
            <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-[#F18E02] dark:border-[#F18E02] mb-6"></div>
