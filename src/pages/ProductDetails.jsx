...
const ProductDetails = () => {
  ...
  const formatPriceDisplay = (product) => {
    if (product.isPriceBasedOnRequest) {
      return (
        <div className="text-[#F18E02] font-bold text-2xl md:text-3xl">
          السعر حسب الطلب
        </div>
      );
    }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-4">
        <div className="text-center">
          ...
          <button
            onClick={() => navigate("/")}
            className="bg-[#F18E02] text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all border border-[#F18E02] hover:bg-[#be6f00]"
          >
            العودة للرئيسية
          </button>
        </div>
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 transition-colors duration-300">
        {/* Option Modal */}
        {showOptionModal && (
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-[#F18E02] focus:border-transparent"
              ...
              <div className="flex gap-3 mt-8">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-[#F18E02] text-white rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center gap-2 border border-[#F18E02] hover:bg-[#be6f00]"
                >
                  <FaSave />
            ...
            >
                  ...
                  <div ref={dropdownRef} className="relative">
                    ...
                    <div
                      className={`w-full px-4 py-3 border rounded-lg cursor-pointer flex items-center justify-between ${
                        showAddonTypeDropdown
                          ? "border-[#F18E02] ring-2 ring-[#F18E02]/20"
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                          <input
                            ...
                            onChange={handleAddonTypeFormChange}
                            className="w-5 h-5 text-[#F18E02] rounded focus:ring-[#F18E02]"
                          />
                          <label
                          ...
                          <div className="space-y-2">
                            <div>
                              <input
                                ...
                                className="w-full px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded dark:bg-gray-700 dark:text-white focus:ring-1 focus:ring-[#F18E02] focus:border-transparent"
              ...
              <div className="flex gap-3 mt-8">
                ...
                <button
                  ...
                  className={`flex-1 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 whitespace-nowrap border ${
                    (selectedAddonType &&
                      !isAddingNewAddonType &&
                      newAddonOptions.length > 0) ||
                    (isAddingNewAddonType && addonTypeForm.name.trim())
                      ? "bg-[#F18E02] text-white hover:shadow-lg transition-all border-[#F18E02] hover:bg-[#be6f00]"
        ...
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-[#F18E02] text-white rounded-full p-3 sm:p-4 shadow-2xl z-40 cursor-pointer hover:scale-110 transition-transform duration-200 border-2 border-white ${
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl md:rounded-3xl shadow-xl md:shadow-2xl overflow-hidden border border-gray-200">
                ...
                {product.itemOffer && product.itemOffer.isEnabled && (
                  ...
                  >
                    <div className="bg-[#F18E02] text-white px-3 py-1.5 md:px-4 md:py-2 rounded-xl shadow-2xl flex items-center gap-1.5 md:gap-2 border border-white">
            ...
            >
                                  ...
                                  <div key={option.id} className="relative">
                                    ...
                                    >
                                      <div className="flex items-center gap-1 md:gap-2">
                                        ...
                                        {isSelected && (
                                          <FaCheck className="text-[#F18E02] text-xs md:text-sm" />
                                        )}
                                      </div>
              ...
              >
                ...
                >
                  ...
                  <div className="text-xl md:text-2xl font-bold text-[#F18E02] whitespace-nowrap text-center sm:text-right order-1 sm:order-2">
                    الإجمالي:{" "}
