...
const OrderDetailsModal = ({ order, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      ...
      >
        {/* Header */}
        <div className="bg-[#F18E02] p-6 relative border-b border-white">
                            ...
                            <div className="text-center">
                              ...
                              <p className="font-bold text-lg text-green-600 dark:text-green-400">
                                {isPriceBasedOnRequest ? (
                                  <span className="text-[#F18E02] dark:text-[#FDB913]">
                                    السعر حسب الطلب
                                  </span>
                                ) : (
                          ...
                          <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                              ...
                              <div className="text-center col-span-2">
                                ...
                                <p className="text-lg font-bold text-[#F18E02] dark:text-[#FDB913]">
          ...
          <div className="bg-gradient-to-r from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-xl font-bold text-[#F18E02] dark:text-[#FDB913]">
...
<div class="print-footer">
  ...
  return (
    <>
      ...
      <div
        dir="rtl"
        className="min-h-screen bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-3 sm:px-4 md:px-6 py-6 relative font-sans overflow-hidden transition-colors duration-300"
      >
        {/* Background decorations */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -left-10 -top-10 w-40 h-40 sm:w-60 sm:h-60 bg-gradient-to-r from-[#F18E02]/10 to-[#000000]/10 rounded-full blur-2xl animate-pulse"></div>
          <div className="absolute -right-10 -bottom-10 w-40 h-40 sm:w-60 sm:h-60 bg-gradient-to-r from-[#000000]/10 to-[#F18E02]/10 rounded-full blur-2xl animate-pulse"></div>
        </div>
        ...
        >
          {/* Header */}
          <div className="bg-[#F18E02] px-6 py-8 relative overflow-hidden border-b border-white">
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                <div className="flex items-center gap-2">
                  <FaCalendar className="text-[#F18E02] text-xl" />
              ...
              >
                <div>
                  ...
                  <div className="relative">
                    <FaCalendarAlt className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#F18E02]" />
                    <DatePicker
                      selected={startDate}
                      ...
                      className="w-full pl-10 pr-3 py-2.5 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-[#F18E02] focus:border-transparent outline-none text-right"
                      locale="ar"
                ...
                <div>
                  ...
                  <div className="relative">
                    <FaClock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#F18E02]" />
                    <input
                      type="time"
                      value={startTime}
                ...
                <div>
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="w-full flex items-center justify-between border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 rounded-lg px-3 py-2.5 text-right focus:ring-2 focus:ring-[#F18E02] focus:border-transparent outline-none hover:border-[#F18E02] transition-all group"
                    >
                      <div className="flex items-center gap-3">
                        <FaBuilding className="text-[#F18E02] text-sm" />
                  ...
                  <div className="flex gap-3">
                    <motion.button
                      ...
                      className={`flex-1 px-4 py-2.5 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 ${
                        startDate && endDate
                          ? "bg-[#F18E02] text-white cursor-pointer hover:bg-[#be6f00] border border-[#F18E02]"
                    ...
                    {reportData && reportData.length > 0 && (
                      <motion.button
                        ...
                        onClick={handlePrint}
                        disabled={isPrinting}
                        className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 border ${
                          isPrinting
            ...
            {summary?.topProducts && summary.topProducts.length > 0 && (
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    <FaChartBar className="text-[#F18E02] text-xl" />
                    <h3 className="text-lg font-bold text-gray-800 dark:text-white">
                ...
                <div className="space-y-3">
                  {summary.topProducts.map((product, index) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-[#F18E02] flex items-center justify-center text-white font-bold border border-white">
                          {index + 1}
                        </div>
                        <div>
              ...
              <>
                ...
                >
                  <div className="px-4 sm:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <FaListAlt className="text-[#F18E02] text-xl" />
                        <h3 className="text-lg font-bold text-gray-800 dark:text-white">
                          تفاصيل الطلبات
                        </h3>
                      </div>
                      ...
                      <table className="w-full">
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                          {reportData.map((order, index) => (
                            ...
                            >
                              ...
                              <td className="px-4 py-3 text-center font-bold text-[#F18E02] dark:text-[#FDB913]">
                              ...
                              <td className="px-4 py-3 text-center">
                                <motion.button
                                  ...
                                  className="flex items-center justify-center gap-2 px-4 py-2 bg-[#F18E02] text-white rounded-lg text-sm font-medium hover:shadow-lg transition-all duration-300 mx-auto hover:bg-[#be6f00] border border-[#F18E02]"
                                >
                                  {loadingDetails &&
                        ...
                        <tfoot className="bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700">
                          <tr>
                            ...
                            <td className="px-4 py-3 text-center">
                              <span className="text-xl font-bold text-[#F18E02] dark:text-[#FDB913]">
