...
const ProductForm = () => {
  ...
  */
  ...
  if (isLoadingProduct) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700">
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-2 xs:px-3 sm:px-4 md:px-6 py-2 xs:py-3 sm:py-6 relative font-sans overflow-hidden transition-colors duration-300`}
        dir="rtl"
      >
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -left-8 xs:-left-10 sm:-left-20 -top-8 xs:-top-10 sm:-top-20 w-32 h-32 xs:w-40 xs:h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-gradient-to-r from-[#F18E02]/10 to-[#F18E02]/05 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
          <div className="absolute -right-8 xs:-right-10 sm:-right-20 -bottom-8 xs:-bottom-10 sm:-bottom-20 w-32 h-32 xs:w-40 xs:h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-gradient-to-r from-[#F18E02]/05 to-[#F18E02]/10 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
        </div>
        ...
        >
          <div className="relative h-28 xs:h-32 sm:h-40 md:h-44 lg:h-52 bg-[#F18E02] overflow-hidden">
            ...
            <motion.button
              ...
              onClick={() => navigate(-1)}
              className="absolute top-2 xs:top-3 sm:top-6 left-2 xs:left-3 sm:left-6 z-50 bg-white/80 backdrop-blur-md hover:bg-[#F18E02] hover:text-white rounded-full p-1.5 xs:p-2 sm:p-3 text-[#F18E02] border border-[#F18E02] shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl group dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#F18E02]"
            >
              <FaArrowLeft
                size={12}
            ...
            >
              <div className="bg-white/80 backdrop-blur-sm rounded-lg xs:rounded-xl sm:rounded-2xl p-3 xs:p-4 sm:p-6 md:p-8 border border-gray-200 dark:bg-gray-700/80 dark:border-gray-600">
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 xs:gap-5 sm:gap-6">
                    <div className="space-y-4 xs:space-y-5 sm:space-y-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full border border-gray-300 bg-white text-black rounded-lg px-3 xs:px-4 py-2 xs:py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-xs sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                                ...
                                <motion.button
                                  ...
                                  className={`flex flex-col items-center gap-1 xs:gap-1.5 sm:gap-2 p-1.5 xs:p-2 sm:p-3 rounded-lg border-2 transition-all duration-200 ${
                                    formData.CategoryId === category.id
                                      ? "border-[#F18E02] bg-white text-[#F18E02] dark:bg-gray-600"
                          ...
                          <div className="grid grid-cols-2 gap-2 xs:gap-3 mb-3">
                            <motion.button
                              ...
                              className={`flex items-center justify-center gap-1.5 xs:gap-2 p-2 xs:p-3 rounded-lg border-2 transition-all duration-200 ${
                                !formData.IsPriceBasedOnRequest
                                  ? "border-[#F18E02] bg-white text-[#F18E02] shadow-md dark:bg-gray-600"
                                  : "border-gray-300 bg-white text-gray-600 hover:border-gray-400 dark:bg-gray-600 dark:border-gray-500 dark:text-gray-300 dark:hover:border-gray-400"
                              }`}
                            >
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          <FaFire className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm transition-all duration-300 group-focus-within:scale-110" />
                          <input
                            type="number"
                            name="Calories"
                            ...
                            min="0"
                            onWheel={(e) => e.target.blur()}
                            className="w-full border border-gray-300 bg-white text-black rounded-lg px-3 xs:px-4 py-2 xs:py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-xs sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:text-white pr-10"
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-2 xs:gap-3">
                          <div className="relative group">
                            <FaClock className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-xs transition-all duration-300 group-focus-within:scale-110" />
                            <input
                              type="number"
                              ...
                              min="0"
                              onWheel={(e) => e.target.blur()}
                              className="w-full border border-gray-300 bg-white text-black rounded-lg px-3 xs:px-4 py-2 xs:py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-xs sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:text-white pr-8"
                              placeholder="من"
                            />
                          </div>
                          <div className="relative group">
                      ...
                      <div>
                        ...
                        <div className="flex gap-3 bg-gray-50/80 dark:bg-gray-600/80 rounded-lg p-2 xs:p-3 border border-gray-300 dark:border-gray-500">
                          <label className="flex-1 flex items-center justify-center gap-2 cursor-pointer p-2 xs:p-3 rounded-lg transition-all duration-200 border-2 border-transparent hover:border-[#F18E02]/30">
                        ...
                        <div className="flex gap-3 bg-gray-50/80 dark:bg-gray-600/80 rounded-lg p-2 xs:p-3 border border-gray-300 dark:border-gray-500">
                          <label className="flex-1 flex items-center justify-center gap-2 cursor-pointer p-2 xs:p-3 rounded-lg transition-all duration-200 border-2 border-transparent hover:border-[#F18E02]/30">
                            ...
                            <div className="flex items-center gap-1.5">
                              <FaSlidersH className="text-[#F18E02] text-xs xs:text-sm" />
                              <span className="text-xs xs:text-sm font-medium text-gray-700 dark:text-gray-300">
                                عرض
                              </span>
                            </div>
                    ...
                    <div className="space-y-4 xs:space-y-5 sm:space-y-6">
                      <div>
                        ...
                        {imageInputMode === "upload" ? (
                          <div
                            className="border-2 border-dashed border-gray-300 rounded-lg p-2 xs:p-3 sm:p-4 text-center hover:border-[#F18E02] transition-colors duration-200 cursor-pointer dark:border-gray-600"
                              ...
                              <div className="mb-3 xs:mb-4">
                                ...
                                <div className="flex gap-2">
                                  <input
                                    ...
                                    className="flex-1 border border-gray-300 bg-white text-black rounded-lg px-3 xs:px-4 py-2 xs:py-2.5 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-xs sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                                  />
                                  <motion.button
                                    type="button"
                                    whileHover={{ scale: 1.02 }}
                                    ...
                                    className={`px-3 xs:px-4 py-2 xs:py-2.5 rounded-lg font-semibold transition-all duration-300 flex items-center gap-1.5 xs:gap-2 text-xs xs:text-sm ${
                                      imageUrl.trim() && !isDownloadingImage
                                        ? "bg-[#F18E02] text-white hover:shadow-xl hover:shadow-[#F18E02]/25 cursor-pointer"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={handleInputChange}
                          rows="3"
                          className="w-full border border-gray-300 bg-white text-black rounded-lg px-3 xs:px-4 py-2 xs:py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 resize-none text-xs sm:text-sm dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                  ...
                  {/*
                <div className="bg-gradient-to-r from-[#fff5f5] to-[#ffe5e5] rounded-lg xs:rounded-xl sm:rounded-2xl p-3 xs:p-4 sm:p-6 border border-[#F18E02]/30 dark:from-gray-600 dark:to-gray-500 dark:border-gray-500">
                  <div className="flex items-center gap-2 xs:gap-3 mb-3 xs:mb-4">
                    <FaClock className="text-[#F18E02] text-base xs:text-lg sm:text-xl" />
                    <h3 className="text-sm xs:text-base sm:text-lg font-bold text-gray-800 dark:text-gray-200">
                      وقت التوفر *
                    </h3>
                  </div>
                  ...
                  {formData.availabilityType === "custom" && (
                    ...
                    >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 xs:gap-4">
                              <div>
                                ...
                                <div className="relative">
                                  <button
                                    ...
                                    className="w-full flex items-center justify-between border border-gray-300 bg-white rounded-lg px-3 py-2 text-black focus:ring-2 focus:ring-[#F18E02] transition-all duration-200 text-xs dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                                    required
                                  >
                              ...
                              <div>
                                ...
                                <input
                                  ...
                                  className="w-full border border-gray-300 bg-white rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-xs dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                                  required
                                />
                              </div>
                            ...
                            <div className="mt-3">
                              <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                  ...
                                  className="text-[#F18E02] focus:ring-[#F18E02]"
                                />
                                <span className="text-xs text-gray-600 dark:text-gray-400">
                                  نشط
                                </span>
                      ...
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        onClick={addSchedule}
                        className="w-full py-2 xs:py-2.5 border-2 border-dashed border-gray-300 text-gray-600 rounded-lg font-semibold hover:border-[#F18E02] hover:text-[#F18E02] transition-all duration-300 text-xs xs:text-sm flex items-center justify-center gap-2 dark:border-gray-500 dark:text-gray-400 dark:hover:border-[#F18E02] dark:hover:text-[#F18E02]"
                      >
                        <FaPlus size={12} />
                ...
                */}
                  ...
                  <div className="flex gap-2 xs:gap-3 sm:gap-4 pt-3 xs:pt-4 sm:pt-6 border-t border-gray-300 dark:border-gray-600">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={() => navigate("/")}
                      className="flex-1 py-2 xs:py-2.5 sm:py-3 border-2 border-[#F18E02] text-[#F18E02] rounded-lg font-semibold hover:bg-[#F18E02] hover:text-white transition-all duration-300 text-xs xs:text-sm sm:text-base flex items-center justify-center gap-1.5 xs:gap-2 dark:border-[#F18E02] dark:text-[#F18E02] dark:hover:bg-[#F18E02] dark:hover:text-white"
                    >
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-600 dark:text-white focus:ring-2 focus:ring-[#F18E02] focus:border-[#F18E02] outline-none transition-all text-right text-base sm:text-lg font-medium"
                            />
                          </div>
                        </div>
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        {optionTypes.map((optionType) => (
                          <motion.div
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            className="bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 hover:border-[#F18E02]/30 dark:hover:border-[#F18E02]/30 rounded-2xl p-4 sm:p-6 transition-all duration-300 hover:shadow-lg group"
                          >
                            {editingOptionType &&
                              ...
                              <div className="space-y-4 sm:space-y-6">
                                <div className="grid grid-cols-1 gap-4 sm:gap-6">
                                  <div>
                                    ...
                                    <input
                                      ...
                                      className="w-full px-3 sm:px-4 py-3 sm:py-4 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-600 dark:text-white focus:ring-2 focus:ring-[#F18E02] focus:border-[#F18E02] outline-none transition-all text-right text-base sm:text-lg font-medium"
                                      dir="rtl"
                                    />
                                  </div>
                                </div>
                                ...
                                <div className="flex gap-2 sm:gap-3 justify-start pt-3 sm:pt-4 border-t border-gray-300 dark:border-gray-600">
                                  ...
                                  <motion.button
                                    ...
                                    className="bg-[#F18E02] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-bold hover:shadow-lg transition-all flex items-center gap-2 text-sm sm:text-base shadow-lg border border-[#F18E02] hover:bg-[#be6f00]"
                                  >
                                    <FaSave />
                                    حفظ التغييرات
                                  </motion.button>
