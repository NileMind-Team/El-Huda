  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="bg-gradient-to-r from-[#F18E02] to-[#B71C1C] px-8 py-6">
            ...
            >
              <div className="flex items-start gap-4 p-6 bg-amber-50 dark:bg-amber-900/20 rounded-xl border border-amber-200 dark:border-amber-800">
                ...
                <div className="space-y-4">
                  ...
                  <a
                    ...
                    className="inline-block text-[#F18E02] hover:text-[#B71C1C] font-bold text-xl transition-colors bg-red-50 dark:bg-red-900/20 px-6 py-3 rounded-lg"
                  >
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-6 space-y-4">
                <h2 className="text-xl font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                  <span className="w-2 h-2 bg-[#F18E02] rounded-full"></span>
                  Email Instructions
                </h2>

                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <span className="font-bold text-[#F18E02]">Subject:</span>
                  ...
                  <div className="flex items-start gap-3">
                    <span className="font-bold text-[#F18E02]">Message:</span>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-lg">
                      ...
                      <span className="font-bold text-[#F18E02]">48 hours</span>
                      .
                    </p>
                  </div>
                </div>
