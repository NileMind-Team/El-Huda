...
export default function Reviews() {
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-3 sm:px-4 md:px-6 py-3 sm:py-6 relative font-sans overflow-hidden transition-colors duration-300`}
      >
        {/* Animated Background Elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -left-10 sm:-left-20 -top-10 sm:-top-20 w-40 h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-gradient-to-r from-[#F18E02]/10 to-[#ffffff]/10 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
          <div className="absolute -right-10 sm:-right-20 -bottom-10 sm:-bottom-20 w-40 h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-gradient-to-r from-[#ffffff]/10 to-[#F18E02]/10 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
        </div>
        ...
        <motion.button
          ...
          onClick={() => navigate(-1)}
          className="fixed top-3 sm:top-4 left-3 sm:left-4 z-50 bg-white/80 backdrop-blur-md hover:bg-[#F18E02] hover:text-white rounded-full p-2 sm:p-3 text-[#F18E02] border border-[#F18E02] shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl group dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#F18E02]"
        >
          <FaArrowLeft
            size={14}
        ...
        >
          {/* Header Background */}
          <div className="relative h-36 sm:h-40 md:h-44 lg:h-52 bg-[#F18E02] overflow-hidden border-b border-white">
            ...
            <div className="relative z-10 h-full flex flex-col justify-end items-center text-center px-4 sm:px-6 pb-6 sm:pb-8 md:pb-10">
              ...
              >
                <div className="p-2 sm:p-3 bg-white/20 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-white">
          ...
          <div className="relative px-3 sm:px-4 md:px-6 lg:px-8 pb-4 sm:pb-6 md:pb-8">
            ...
            >
              <motion.button
                ...
                className="flex items-center gap-2 bg-[#F18E02] text-white px-4 sm:px-5 md:px-6 py-3 sm:py-3 md:py-4 rounded-xl sm:rounded-2xl font-semibold shadow-2xl sm:shadow-3xl hover:shadow-4xl hover:shadow-[#F18E02]/50 transition-all duration-300 text-sm sm:text-base md:text-lg border-2 border-white whitespace-nowrap transform translate-y-2"
              >
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
                ...
                <AnimatePresence>
                  {reviews.map((review, index) => (
                    <motion.div
                      ...
                      className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 lg:p-6 border-2 border-gray-200 transition-all duration-300 hover:shadow-lg dark:bg-gray-700/80 dark:border-gray-600"
                    >
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                            <div className="p-1 sm:p-2 rounded-lg sm:rounded-xl bg-gradient-to-r from-[#fff5f5] to-[#ffe5e5] border border-gray-300 dark:from-gray-600 dark:to-gray-500 dark:border-gray-500">
                              <FaStore className="text-[#F18E02] text-xs sm:text-sm" />
                            </div>
                        ...
                        <div className="flex flex-row sm:flex-col lg:flex-row gap-1 sm:gap-2 justify-end sm:justify-start">
                          <motion.button
                            ...
                            className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-blue-50 text-blue-700 rounded-lg hover:bg-blue-100 transition-colors duration-200 text-xs sm:text-sm font-medium flex-1 sm:flex-none justify-center border border-blue-200 dark:bg-blue-900/30 dark:text-blue-300 dark:hover:bg-blue-900/50 dark:border-blue-700"
                          >
                          ...
                          <motion.button
                            ...
                            className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-red-50 text-red-700 rounded-lg hover:bg-red-100 transition-colors duration-200 text-xs sm:text-sm font-medium flex-1 sm:flex-none justify-center border border-red-200 dark:bg-red-900/30 dark:text-red-300 dark:hover:bg-red-900/50 dark:border-red-700"
                          >
                ...
                {reviews.length === 0 && !isAdding && (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      onClick={handleAddNewReview}
                      className="flex items-center gap-2 bg-[#F18E02] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 text-sm sm:text-base mx-auto border border-white"
                    >
              ...
              <AnimatePresence>
                {isAdding && (
                  ...
                  >
                    <div className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 lg:p-6 border border-gray-200 shadow-lg sticky top-4 sm:top-6 dark:bg-gray-700/80 dark:border-gray-600">
                      <div className="flex items-center justify-between mb-3 sm:mb-4">
                        ...
                        <button
                          onClick={resetForm}
                          className="text-gray-500 hover:text-[#F18E02] transition-colors duration-200 flex-shrink-0 ml-2 dark:text-gray-400 border border-gray-300 p-1 rounded-full"
                        >
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <button
                              ...
                              className="w-full flex items-center justify-between border border-gray-300 bg-white rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 text-gray-600 hover:border-[#F18E02] transition-all group text-sm sm:text-base dark:bg-gray-600 dark:border-gray-500 dark:text-gray-300"
                            >
                              <div className="flex items-center gap-3">
                                <FaStore className="text-[#F18E02] text-sm" />
                                <span>
                                  {formData.branchId
                                    ? branches.find(
                                        (b) =>
                            ...
                            <AnimatePresence>
                              {openDropdown === "branch" && (
                                <motion.ul
                                  ...
                                  className="absolute z-10 mt-2 w-full bg-white border border-gray-300 shadow-xl rounded-lg sm:rounded-xl overflow-hidden max-h-48 overflow-y-auto dark:bg-gray-700 dark:border-gray-600"
                                >
                                  {branches.map((branch) => (
                                    <li
                                      key={branch.id}
                                      ...
                                      className="px-4 py-2.5 sm:py-3 hover:bg-gradient-to-r hover:from-[#fff5f5] hover:to-[#ffe5e5] cursor-pointer text-gray-700 transition-all text-sm sm:text-base border-b border-gray-200 last:border-b-0 dark:hover:from-gray-600 dark:hover:to-gray-500 dark:text-gray-300 dark:border-gray-600"
                                    >
                                      {branch.name}
                                    </li>
                                  ))}
                        ...
                        <div>
                          ...
                          <div className="flex items-center justify-between gap-2 bg-gradient-to-r from-[#fff5f5] to-[#ffe5e5] p-2 sm:p-3 rounded-lg sm:rounded-xl border border-gray-300 dark:from-gray-600 dark:to-gray-500 dark:border-gray-500">
                            <div className="flex items-center gap-2 flex-shrink-0">
                              <FaStar className="text-[#F18E02] text-xs sm:text-sm" />
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-xs sm:text-sm font-semibold text-[#F18E02] whitespace-nowrap">
                                ({formData.rating}/5)
                              </span>
                            </div>
                          </div>
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            required
                            rows="4"
                            className="w-full border border-gray-300 bg-white text-black rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-sm sm:text-base resize-none dark:bg-gray-600 dark:border-gray-500 dark:text-white"
                        ...
                        <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2">
                          <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            onClick={resetForm}
                            className="flex-1 py-2.5 sm:py-3 border-2 border-[#F18E02] text-[#F18E02] rounded-lg sm:rounded-xl font-semibold hover:bg-[#F18E02] hover:text-white transition-all duration-300 text-sm sm:text-base dark:border-[#F18E02] dark:text-[#F18E02] dark:hover:bg-[#F18E02] dark:hover:text-white"
                          >
                            إلغاء
                          </motion.button>
                          <motion.button
                            ...
                            className={`flex-1 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold transition-all duration-300 text-sm sm:text-base flex items-center justify-center gap-1 sm:gap-2 border ${
                              isFormValid()
                                ? "bg-[#F18E02] text-white hover:shadow-xl hover:shadow-[#F18E02]/25 cursor-pointer border-white"
