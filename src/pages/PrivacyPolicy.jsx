      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="p-8 space-y-8">
            ...
            >
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-6 border-r-4 border-[#F18E02]">
              ...
              <div className="mt-8 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl p-6">
                ...
                <a
                  ...
                  className="inline-block mt-3 text-[#F18E02] hover:text-[#B71C1C] font-medium text-lg transition-colors"
                >
