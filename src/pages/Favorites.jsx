...
const Favorites = () => {
  ...
  const showNotification = (type, title, text, options = {}) => {
    if (options.showConfirmButton || options.showCancelButton) {
      Swal.fire({
        ...
        confirmButtonColor: "#F18E02", // Updated: Red color
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-3 sm:px-4 md:px-6 py-3 sm:py-6 relative font-sans overflow-hidden transition-colors duration-300">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -left-10 sm:-left-20 -top-10 sm:-top-20 w-40 h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-[#F18E02]/10 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
          <div className="absolute -right-10 sm:-right-20 -bottom-10 sm:-bottom-20 w-40 h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-[#F18E02]/10 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
        </div>
        ...
        >
          <div className="relative h-36 sm:h-40 md:h-44 lg:h-52 bg-[#F18E02] overflow-hidden">
            ...
            {favoriteProducts.length === 0 ? (
              ...
              >
                <div className="max-w-md mx-auto">
                  <div className="bg-[#F18E02] w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6 border-4 border-white">
                  ...
                  <motion.button
                    ...
                    className="bg-[#F18E02] text-white px-8 py-4 rounded-2xl font-bold hover:shadow-2xl hover:bg-[#be6f00] transition-all duration-300 flex items-center gap-3 mx-auto text-lg border border-[#F18E02]"
                  >
                    <FaHome />
                    ابدأ التسوق الآن
                    <FaArrowRight />
                  ...
                  >
                      ...
                      <div className="p-3">
                        <div className="flex">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3
                              className="font-bold text-sm text-gray-800 dark:text-gray-200 group-hover:text-[#F18E02] transition-colors line-clamp-1 mb-2"
                      ...
                      <div className="px-3 pb-3">
                        <div className="flex gap-2">
                          <motion.button
                            ...
                            className={`flex-1 py-2.5 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 text-xs no-product-details ${
                              addingToCart === product.id
                                ...
                                : product.isActive
                                  ? "bg-gradient-to-r from-[#F18E02] to-[#FDB913] text-white"
                          ...
                          <motion.button
                            ...
                            className="p-2.5 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 flex items-center justify-center text-xs no-product-details text-[#F18E02] bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/30 border border-red-200 dark:border-red-700"
                          >
                            <FaHeart size={16} />
                          </motion.button>
                        </div>
                    ...
                    <div className="hidden sm:block">
                      ...
                      <div className="p-3 sm:p-4">
                        <h3
                          className="font-bold text-base sm:text-lg text-gray-800 dark:text-gray-200 mb-2 group-hover:text-[#F18E02] transition-colors line-clamp-1"
                          dir={isArabic(product.name) ? "rtl" : "ltr"}
                        >
                          {product.name}
                        </h3>
                        ...
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <motion.button
                            ...
                            className="p-2 sm:p-2.5 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 flex items-center justify-center no-product-details text-[#F18E02] bg-red-50 dark:bg-red-900/20 hover:bg-red-100 dark:hover:bg-red-900/30 border border-red-200 dark:border-red-700"
                          >
                            <FaHeart size={18} />
                          </motion.button>
                        </div>
        ...
        <motion.div
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-[#F18E02] text-white rounded-full p-3 sm:p-4 shadow-2xl z-40 cursor-pointer hover:scale-110 transition-transform duration-200 no-product-details border-2 border-white ${
