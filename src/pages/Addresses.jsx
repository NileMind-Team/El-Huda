    ...
    return (
      <div
        className={`min-h-screen flex items-center justify-center ${
          darkMode
            ? "dark bg-gray-900"
            : "bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0]"
        } px-4`}
      >
      ...
      >
        ...
        <motion.button
          ...
          className={`fixed top-3 sm:top-4 left-3 sm:left-4 z-50 ${
            darkMode
              ? "bg-gray-800/80 text-white border-gray-600 hover:bg-[#F18E02]"
              : "bg-white/80 text-[#F18E02] border-[#F18E02] hover:bg-[#F18E02] hover:text-white"
          ...
          {showMapModal && (
            ...
            >
              <motion.div
                ...
                } rounded-2xl sm:rounded-3xl w-full max-w-4xl max-h-[85vh] overflow-hidden shadow-2xl flex flex-col border border-gray-300`}
              >
                <div
                  className={`${
                ...
                >
                  <div className="flex items-center gap-3">
                    <FaMap className="text-[#F18E02] text-xl" />
                    <h3
                    ...
                    {!mapLoaded && (
                      <div className="flex items-center justify-center h-64 bg-gray-100 dark:bg-gray-700 rounded-lg border border-gray-300">
                        <div className="text-center">
                          <div className="animate-spin rounded-full h-12 w-12 border-t-4 border-b-4 border-[#F18E02] mx-auto mb-4"></div>
                          <p
                            className={`text-sm ${
                              darkMode ? "text-gray-300" : "text-gray-600"
                            }`}
                      ...
                      >
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                          ...
                          <motion.button
                            ...
                            className="bg-[#F18E02] text-white px-6 py-3 rounded-lg font-semibold text-sm hover:shadow-lg transition-all duration-200 flex items-center gap-2 whitespace-nowrap flex-shrink-0 border border-white"
                          >
                            ...
                            <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                              ...
                              <div className="min-w-0 flex-1">
                                <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                                  ...
                                  {address.isDefaultLocation && (
                                    <span className="bg-[#F18E02] text-white text-xs px-2 py-1 rounded-full whitespace-nowrap inline-flex items-center gap-1 self-start sm:self-center border border-white">
                            ...
                            <motion.div
                              ...
                              className={`relative w-6 h-6 sm:w-7 sm:h-7 rounded-full border-2 cursor-pointer transition-all duration-200 flex items-center justify-center ml-2 flex-shrink-0 sm:hidden ${
                                address.isDefaultLocation
                                  ...
                                  : darkMode
                                    ? "border-gray-500 bg-gray-800 hover:border-[#F18E02] group-hover:border-[#F18E02]"
                                    : "border-gray-300 bg-white hover:border-[#F18E02] group-hover:border-[#F18E02]"
                              }`}
                            >
                              {address.isDefaultLocation && (
                                <motion.div
                    ...
                    >
                      <div className="flex items-center justify-between mb-3 sm:mb-4">
                        ...
                        <button
                          ...
                          className={`${
                            darkMode
                              ? "text-gray-400 hover:text-[#F18E02]"
                              : "text-gray-500 hover:text-[#F18E02]"
                      ...
                      >
                          ...
                          <div className="relative">
                            <button
                              ...
                              className={`w-full flex items-center justify-between border ${
                                darkMode
                                  ? "border-gray-600 bg-gray-800 text-gray-300 hover:border-[#F18E02]"
                                  : "border-gray-300 bg-white text-gray-600 hover:border-[#F18E02]"
                              } rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 transition-all group text-sm sm:text-base`}
                            >
                              <div className="flex items-center gap-3">
                                <FaCity className="text-[#F18E02] text-sm" />
                                <span>
                                  {formData.cityId
                                    ? cities.find(
                                        (c) =>
                        ...
                        <div>
                          ...
                          <div className="relative group">
                            <FaPhone className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm transition-all duration-300 group-focus-within:scale-110" />
                            <input
                              type="tel"
                              name="phoneNumber"
                              ...
                              } rounded-lg sm:rounded-xl pl-9 pr-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-sm sm:text-base`}
                        ...
                        <div>
                          ...
                          <div className="relative group">
                            <FaRoad className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm transition-all duration-300 group-focus-within:scale-110" />
                            <input
                              type="text"
                              name="streetName"
                        ...
                        <div className="grid grid-cols-1 xs:grid-cols-3 gap-2 sm:gap-3 md:gap-4">
                          <div>
                            ...
                            <div className="relative group">
                              <FaBuildingIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm transition-all duration-300 group-focus-within:scale-110" />
                              <input
                                type="text"
                                inputMode="numeric"
                                pattern="[0-9٠-٩]*"
                          ...
                          <div>
                            ...
                            <div className="relative group">
                              <FaTag className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm transition-all duration-300 group-focus-within:scale-110" />
                              <input
                                type="text"
                                inputMode="numeric"
                                pattern="[0-9٠-٩]*"
                          ...
                          <textarea
                            ...
                            className={`w-full border ${
                              darkMode
                                ? "border-gray-600 bg-gray-800 text-white"
                                : "border-gray-300 bg-white text-black"
                            } rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-sm sm:text-base resize-none`}
                        ...
                        <div>
                          ...
                          <motion.button
                            ...
                            className="flex items-center gap-2 w-full mb-2 px-3 py-2.5 bg-[#F18E02] text-white rounded-lg hover:shadow-lg transition-all duration-200 text-sm font-semibold border border-white"
                          >
