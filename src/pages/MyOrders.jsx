  ...
  const showMessage = (type, title, text, options = {}) => {
    if (isMobile() && !options.forceSwal) {
      ...
      Swal.fire({
        ...
        title: title,
        text: text,
        confirmButtonColor: options.confirmButtonColor || "#F18E02",
...
`;
  ...
  return (
    <>
      ...
      <div
        className={`min-h-screen bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-3 sm:px-4 py-4 sm:py-8 transition-colors duration-300`}
      >
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate(-1)}
                className="bg-white/80 backdrop-blur-md rounded-full p-2 sm:p-3 text-[#F18E02] hover:bg-[#F18E02] hover:text-white transition-all duration-300 shadow-lg dark:bg-gray-800/80 dark:text-gray-200 dark:hover:bg-[#F18E02] border-2 border-white"
              >
                ...
                <div>
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="w-full flex items-center justify-between border-2 border-gray-300 bg-white rounded-xl px-4 py-3 text-black focus:ring-2 focus:ring-[#F18E02] focus:border-[#F18E02] transition-all duration-200 text-sm sm:text-base dark:bg-gray-700 dark:border-gray-600 dark:text-white hover:border-[#F18E02]"
                    >
                      <span className="flex items-center gap-2">
                        <FaFilter className="text-[#F18E02]" />
                        {filter === "all"
                          ? "جميع الحالات"
                                  ...
                                  <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-600 overflow-hidden flex-shrink-0 border border-gray-300">
                                      ...
                                      user.imageUrl !==
                                        ...
                                        <div className="w-full h-full flex items-center justify-center bg-[#F18E02] text-white text-xs">
                          ...
                          >
                            ...
                            {loadingBranches ? (
                              ...
                              branches.map((branch) => (
                                ...
                                >
                                  <div className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-[#F18E02] flex items-center justify-center text-white text-xs font-bold border border-white">
                  ...
                  <div className="block sm:hidden space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl bg-white text-black focus:ring-2 focus:ring-[#F18E02] focus:border-[#F18E02] transition-all duration-200 text-sm sm:text-base dark:bg-gray-700 dark:border-gray-600 dark:text-white hover:border-[#F18E02]"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  ...
                  <div className="flex pt-2 sm:pt-0">
                    {(dateRange.start ||
                      ...
                      <button
                        ...
                        className="w-full sm:w-auto px-4 py-3 bg-[#F18E02] text-white rounded-xl hover:bg-[#d07900] transition-colors duration-200 text-sm sm:text-base whitespace-nowrap flex items-center justify-center gap-2 border-2 border-white"
                      >
          ...
          {fetchingOrders && (
            ...
            >
              <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-[#F18E02] mb-4"></div>
            </motion.div>
          )}
                ...
                {orders.map((order, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="bg-white/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-4 sm:p-6 cursor-pointer hover:shadow-2xl transition-all duration-300 dark:bg-gray-800/90 border-2 border-gray-300 hover:border-[#F18E02]"
                      ...
                      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                            <div className="flex items-center gap-2">
                              <FaMapMarkerAlt className="text-[#F18E02] flex-shrink-0 w-3 h-3" />
                            ...
                            {order.location?.phoneNumber && (
                              <div className="flex items-center gap-2 sm:ml-4">
                                <FaPhone className="text-[#F18E02] flex-shrink-0 w-3 h-3" />
                        ...
                        <div className="flex flex-row sm:flex-col items-center justify-between sm:items-end lg:items-start gap-3 sm:gap-2 lg:gap-3 pt-3 sm:pt-0 border-t sm:border-t-0 border-gray-200 dark:border-gray-700">
                          <div className="text-left sm:text-right lg:text-left">
                            <div className="text-lg sm:text-xl font-bold text-[#F18E02]">
                          ...
                          <div className="flex items-center gap-2 text-[#F18E02]">
            ...
            {!fetchingOrders && orders.length === 0 && (
              ...
              >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => navigate("/")}
                  className="bg-[#F18E02] text-white px-6 sm:px-8 py-2 sm:py-3 rounded-xl font-bold hover:bg-[#d07900] transition-all duration-300 text-sm sm:text-base border-2 border-white"
                >
                  ابدأ التسوق
                </motion.button>
              </motion.div>
          ...
          <>
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md overflow-visible mx-auto relative border-2 border-gray-300">
                {/* Modal Header */}
                <div className="bg-[#F18E02] p-5 sm:p-6 border-b border-white">
                ...
                <div className="p-5 sm:p-6 relative">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative" ref={statusDropdownRef}>
                        <button
                          ...
                          className="status-dropdown-trigger w-full flex items-center justify-between border-2 border-gray-300 bg-white dark:bg-gray-700 dark:border-gray-600 rounded-xl px-4 py-3 text-black dark:text-white focus:ring-2 focus:ring-[#F18E02] focus:border-[#F18E02] transition-all duration-200 hover:border-[#F18E02]"
                        >
                          <span className="flex items-center gap-2">
                            <FaFilter className="text-[#F18E02]" />
                            {newStatus
                  ...
                  <div className="flex gap-3">
                    ...
                    <motion.button
                      ...
                      className="flex-1 px-4 py-3 bg-[#F18E02] text-white rounded-xl font-semibold hover:bg-[#d07900] transition-all disabled:opacity-50 disabled:cursor-not-allowed border-2 border-[#F18E02]"
                    >
                      {updatingStatus ? (
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col mx-auto my-auto h-full sm:h-auto border-2 border-gray-300">
                ...
                <div className="flex items-center justify-between p-4 sm:p-6 border-b-2 border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800">
                  <div className="flex items-center gap-3 min-w-0">
                    <FaReceipt className="text-[#F18E02] text-xl sm:text-2xl flex-shrink-0" />
                    <div className="min-w-0">
                ...
                <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6">
                  {loadingOrderDetails ? (
                    <div className="flex flex-col items-center justify-center h-48 sm:h-64">
                      <div className="animate-spin rounded-full h-12 w-12 sm:h-16 sm:w-16 border-t-4 border-b-4 border-[#F18E02] mb-4"></div>
                    </div>
                  ) : orderDetails ? (
                    <div className="space-y-4 sm:space-y-6">
                      ...
                      <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-gray-300">
                        <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2 text-base sm:text-lg">
                          <FaUser className="text-[#F18E02] flex-shrink-0" />
                          معلومات العميل
                        </h3>
                      ...
                      {isAdminOrRestaurant &&
                        orderDetails.deliveryFee?.branchId && (
                          <div className="bg-gray-50 dark:bg-gray-700/50 border-2 border-gray-300 dark:border-gray-600 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5">
                            <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2 text-base sm:text-lg">
                              <FaStore className="text-[#F18E02] flex-shrink-0" />
                              معلومات الفرع
                            </h3>
                            <div className="space-y-2 sm:space-y-3">
                              <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-[#F18E02] flex items-center justify-center text-white font-bold border-2 border-white">
                                  {branches
                                    .find(
                                      (b) =>
                                        b.id ===
                      ...
                      {orderDetails.items && orderDetails.items.length > 0 && (
                        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-gray-300">
                          <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2 text-base sm:text-lg">
                            <FaBox className="text-[#F18E02] flex-shrink-0" />
                                  ...
                                  <div className="bg-gray-50 dark:bg-gray-800/30 border-t-2 border-gray-200 dark:border-gray-700 p-3 sm:p-4">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs sm:text-sm">
                                      ...
                                      <div className="col-span-full flex items-center gap-2 pt-2 border-t-2 border-gray-300 dark:border-gray-700">
                                        <FaInfoCircle className="text-[#F18E02] w-3 h-3" />
                                        <span className="text-gray-600 dark:text-gray-400">
                                          السعر النهائي (بعد الخصم والاضافات):
                                        </span>
                                        <span className="font-bold text-[#F18E02]">
                                          ج.م {itemFinalPrice.toFixed(2)}
                                        </span>
                                      </div>
                                    </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 border-2 border-gray-300">
                          <h3 className="font-bold text-gray-800 dark:text-gray-200 mb-3 flex items-center gap-2 text-sm sm:text-base">
                            <FaInfoCircle className="text-[#F18E02] flex-shrink-0" />
                            معلومات إضافية
                          </h3>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs sm:text-sm">
                            <div className="flex items-center gap-2">
      ...
      <AnimatePresence>
        {printingOrderId && (
          <>
            ...
            >
              <div className="animate-spin rounded-full h-12 w-12 sm:h-16 sm:w-16 border-t-4 border-b-4 border-[#F18E02]"></div>
            </motion.div>
          </>
        )}
      </AnimatePresence>
