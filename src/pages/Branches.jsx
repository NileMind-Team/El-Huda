    ...
    <>
      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -left-10 sm:-left-20 -top-10 sm:-top-20 w-40 h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-gradient-to-r from-[#F18E02]/10 to-[#FDB913]/10 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
          <div className="absolute -right-10 sm:-right-20 -bottom-10 sm:-bottom-20 w-40 h-40 sm:w-60 sm:h-60 md:w-80 md:h-80 bg-gradient-to-r from-[#FDB913]/10 to-[#F18E02]/10 rounded-full blur-2xl sm:blur-3xl animate-pulse"></div>
        </div>
              ...
              >
                <div className="bg-gray-50 dark:bg-gray-700 px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 dark:border-gray-600 flex items-center justify-between flex-shrink-0">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <FaMap className="text-[#F18E02] text-lg sm:text-xl" />
        ...
        >
          {/* Header */}
          <div className="relative h-32 sm:h-36 md:h-40 lg:h-44 xl:h-52 bg-gradient-to-r from-[#F18E02] to-[#FDB913] overflow-hidden">
            ...
            <div className="relative z-10 h-full flex flex-col justify-end items-center text-center px-3 sm:px-4 md:px-6 pb-4 sm:pb-6 md:pb-8 lg:pb-10">
              ...
              >
                اكتشف فروع El-Huda القريبة منك وتعرّف على تفاصيل كل فرع
                وتقييمات العملاء
              </motion.p>
            </div>
          </div>
            ...
            >
              ...
              <div className="max-w-full sm:max-w-2xl mx-auto">
                <div className="relative group">
                  <FaSearch className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-xs sm:text-sm transition-all duration-300 group-focus-within:scale-110" />
                  <input
                    type="text"
                    value={searchTerm}
                    onChange={(e) => setSearchTerm(e.target.value)}
                    className="w-full border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-black dark:text-white rounded-lg sm:rounded-xl md:rounded-2xl pl-9 sm:pl-10 pr-3 sm:pr-4 py-2.5 sm:py-3 md:py-4 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-transparent transition-all duration-200 text-xs sm:text-sm md:text-base shadow"
            ...
            {filteredBranches.length === 0 ? (
              ...
              >
                <div className="max-w-md mx-auto px-3">
                  <div className="bg-gradient-to-r from-[#F18E02] to-[#FDB913] w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                  ...
                  {searchTerm && (
                    <motion.button
                      ...
                      className="bg-gradient-to-r from-[#F18E02] to-[#FDB913] text-white px-6 sm:px-8 py-2.5 sm:py-3 md:py-4 rounded-xl sm:rounded-2xl font-bold hover:shadow-xl transition-all duration-300 text-sm sm:text-base md:text-lg"
                    >
                      عرض جميع الفروع
                    </motion.button>
                  )}
                      ...
                      <div
                        className={`p-1.5 rounded-lg transition-colors duration-300 ${
                          selectedBranch?.id === branch.id
                            ? "bg-[#F18E02] text-white"
                            : "bg-gray-100 dark:bg-gray-600 text-[#F18E02]"
                        }`}
                        ...
                        <div className="flex-1">
                          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-3">
                            <div className="flex items-start gap-2 sm:gap-3">
                              <div className="p-1.5 sm:p-2 md:p-3 bg-gradient-to-r from-[#F18E02] to-[#FDB913] rounded-lg sm:rounded-xl text-white flex-shrink-0">
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="grid grid-cols-1 xs:grid-cols-2 gap-2 sm:gap-3">
                                  <div className="flex items-center gap-1.5 sm:gap-2 text-gray-600 dark:text-gray-400">
                                    <FaCity className="text-[#F18E02] text-xs sm:text-sm flex-shrink-0" />
                                  ...
                                  <div className="flex items-center gap-1.5 sm:gap-2 text-gray-600 dark:text-gray-400">
                                    <FaClock className="text-[#F18E02] text-xs sm:text-sm flex-shrink-0" />
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                              ...
                              <div className="lg:col-span-2 space-y-4 sm:space-y-6">
                                <div className="space-y-3 sm:space-y-4">
                                  ...
                                  {/* Address */}
                                  <div className="flex items-start gap-2 sm:gap-3">
                                    <FaMapMarkerAlt className="text-[#F18E02] mt-0.5 sm:mt-1 flex-shrink-0 text-sm sm:text-base" />
                                    <div className="flex-1 min-w-0">
                                  ...
                                  {branch.email && (
                                    <div className="flex items-start gap-2 sm:gap-3">
                                      <FaEnvelope className="text-[#F18E02] mt-0.5 sm:mt-1 flex-shrink-0 text-sm sm:text-base" />
                                      <div className="flex-1 min-w-0">
                                        <p className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm mb-1">
                                          البريد الإلكتروني
                                        </p>
                                  ...
                                  {branch.phoneNumbers &&
                                    branch.phoneNumbers.length > 0 && (
                                      <div className="flex items-start gap-2 sm:gap-3">
                                        <FaPhone className="text-[#F18E02] mt-0.5 sm:mt-1 flex-shrink-0 text-sm sm:text-base" />
                                        <div className="flex-1 min-w-0">
                                      ...
                                      >
                                        <div className="flex items-center gap-2">
                                          <h4 className="text-base sm:text-lg md:text-xl font-bold text-gray-800 dark:text-gray-200 flex items-center gap-2">
                                            <FaCommentAlt className="text-[#F18E02]" />
                                            تقييمات العملاء
                                        ...
                                        <div>
                                          {showReviews[branch.id] ? (
                                            <FaChevronUp className="text-[#F18E02]" />
                                          ) : (
                                                      ...
                                                      <div className="flex items-center gap-2 sm:gap-3">
                                                        ...
                                                        <div className="flex-shrink-0">
                                                          {review.user
                                                            ...
                                                            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-r from-[#F18E02] to-[#FDB913] flex items-center justify-center">
                                                    ...
                                                    {review.comment && (
                                                      <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 sm:p-4">
                                                        <div className="flex items-start gap-2">
                                                          <FaCommentAlt className="text-[#F18E02] mt-0.5 text-xs sm:text-sm flex-shrink-0" />
                              ...
                              <div className="space-y-4 sm:space-y-6">
                                ...
                                {branch.locationUrl && (
                                  <motion.button
                                    ...
                                    className="w-full py-2.5 sm:py-3 md:py-4 bg-gradient-to-r from-[#F18E02] to-[#FDB913] text-white rounded-lg sm:rounded-xl font-semibold hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-1.5 sm:gap-2 text-sm sm:text-base md:text-lg"
                                  >
