                          ...
                          <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                              ...
                              <div className="text-center col-span-2">
                                ...
                                <p className="text-lg font-bold text-[#F18E02]">
          ...
          <div className="bg-gradient-to-r from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-xl font-bold text-[#F18E02]">
...
const SalesReports = () => {
  ...
  // دالة جديدة للحصول على اسم الفرع للطلب
...
<title>تقرير المبيعات - El-Huda</title>
<style>
  @media print {
...
<div class="print-footer">
  ...
  <p>El-Huda © ${toArabicNumbers(new Date().getFullYear())}</p>
</div>
            ...
            >
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                <div className="flex items-center gap-2">
                  <FaCalendarAlt className="text-[#F18E02] text-xl" />
                      ...
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-3 py-2.5 border ${
                          isBranchDropdownOpen
                            ? "border-[#F18E02] ring-2 ring-[#F18E02]/30"
                            : "border-gray-300 dark:border-gray-600"
                        } dark:bg-gray-700 dark:text-white rounded-lg focus:ring-2 focus:ring-[#F18E02] focus:border-transparent outline-none text-right group transition-all`}
                      >
                        <div className="flex items-center gap-2">
                          <FaBuilding className="text-[#F18E02]" />
                          <span className="text-sm">
                            {getSelectedBranchName()}
                          </span>
                        </div>
                        <FaChevronDown
                          className={`text-[#F18E02] transition-transform duration-300 ${
                      ...
                      <table className="w-full">
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                          {reportData.map((order, index) => (
                            ...
                            >
                              ...
                              <td className="px-4 py-3 text-center font-bold text-[#F18E02]">
                        ...
                        <tfoot className="bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700">
                          <tr>
                            ...
                            <td className="px-4 py-3 text-center">
                              <span className="text-xl font-bold text-[#F18E02]">
