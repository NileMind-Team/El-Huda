...
const HeroSwipper = () => {
    ...
    const fetchSliderItems = async () => {
      try {
        ...
        const formattedSlides = sliderItems.map((item, index) => {
          ...
          if (item.preparationTimeStart) {
            if (item.preparationTimeEnd) {
  ...
  if (loading) {
    return (
      <div className="relative w-full h-[40vh] sm:h-[45vh] md:h-[50vh] lg:h-[55vh] min-h-[300px] sm:min-h-[350px] md:min-h-[400px] lg:min-h-[450px] max-h-[400px] sm:max-h-[450px] md:max-h-[500px] lg:max-h-[600px] overflow-hidden rounded-b-2xl shadow-xl bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800 flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 border-t-4 border-b-4 border-[#F18E02]"></div>
      </div>
    );
  }
  ...
  if (slides.length === 0) {
    return (
      <div className="relative w-full h-[40vh] sm:h-[45vh] md:h-[50vh] lg:h-[55vh] min-h-[300px] sm:min-h-[350px] md:min-h-[400px] lg:min-h-[450px] max-h-[400px] sm:max-h-[450px] md:max-h-[500px] lg:max-h-[600px] overflow-hidden rounded-b-2xl shadow-xl bg-gradient-to-r from-[#F18E02]/10 to-[#000000]/10 dark:from-[#F18E02]/20 dark:to-[#000000]/20 flex items-center justify-center">
        <div className="text-center px-4">
          <div className="bg-[#F18E02] p-3 sm:p-4 rounded-2xl inline-block mb-3 sm:mb-4">
                    ...
                    <div className="h-full flex flex-row items-center justify-between gap-2 sm:gap-3 md:gap-4 lg:gap-6 py-1 sm:py-2 md:py-4">
                      ...
                      >
                            ...
                            {!slide.isPriceBasedOnRequest &&
                              ...
                              slide.discountType !== "none" && (
                                <motion.div
                                  ...
                                  className="relative"
                                >
                                  <div className="bg-[#F18E02] text-white px-1.5 py-1 sm:px-2 sm:py-1 md:px-3 md:py-1.5 rounded-md sm:rounded-lg shadow-md flex items-center gap-0.5 sm:gap-1 w-fit border border-white">
                        ...
                        <motion.button
                          ...
                          dir="rtl"
                        >
                          <div className="absolute inset-0 bg-[#F18E02] opacity-0 group-hover:opacity-20 transition-opacity duration-250"></div>
                            ...
                            {!slide.isPriceBasedOnRequest &&
                              ...
                              slide.discountType !== "none" && (
                                <motion.div
                                  ...
                                  className="absolute top-1 left-1 sm:top-1.5 sm:left-1.5 md:top-2 md:left-2 bg-[#F18E02] text-white px-1 py-0.5 sm:px-1.5 sm:py-0.5 md:px-2 md:py-1 rounded-md shadow-md w-fit border border-white"
                                >
