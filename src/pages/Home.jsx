...
const Home = () => {
  ...
  const showNotification = (type, title, text, options = {}) => {
    if (options.showConfirmButton || options.showCancelButton) {
      Swal.fire({
        ...
        confirmButtonColor: "#F18E02", // Updated: Orange primary color
  ...
  const formatPriceDisplay = (product) => {
    if (product.isPriceBasedOnRequest) {
      return (
        <div className="text-[#F18E02] font-bold text-lg sm:text-xl">
          السعر حسب الطلب
        </div>
      );
    }
  ...
  const formatPriceDisplayMobile = (product) => {
    if (product.isPriceBasedOnRequest) {
      return (
        <div className="text-[#F18E02] font-bold text-sm">السعر حسب الطلب</div>
      );
    }
    ...
    if (product.itemOffer && product.itemOffer.isEnabled) {
      return (
        <>
          ...
          <div className="text-[#F18E02] font-bold text-sm">
            {product.finalPrice.toFixed(2)} ج.م
          </div>
        </>
      );
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-4">
        <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-b-4 border-[#F18E02]"></div>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      {showAddonsModal && (
        <>
          ...
          >
            ...
            >
              <div className="bg-[#F18E02] text-white p-4 sm:p-6 relative border-b border-white">
              ...
              >
                {modalLoading ? (
                  <div className="flex items-center justify-center py-8 sm:py-12">
                    <div className="animate-spin rounded-full h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 border-t-4 border-b-4 border-[#F18E02]"></div>
                  </div>
                                  ...
                                  <div key={option.id} className="w-full">
                                    <button
                                      ...
                                      className={`w-full p-2 sm:p-3 rounded-lg border-2 transition-all duration-200 flex items-center justify-between ${
                                        isSelected
                                          ? "border-[#F18E02] bg-orange-50 dark:bg-orange-900/20"
                                    ...
                                    >
                                      <div className="flex items-center gap-1 sm:gap-2 truncate min-w-0">
                                        ...
                                        {isSelected && (
                                          <FaCheck className="text-[#F18E02] flex-shrink-0 w-3 h-3 sm:w-4 sm:h-4" />
                                        )}
                                      </div>
                      ...
                      <button
                        ...
                        className={`flex-1 py-2 sm:py-3 rounded-lg font-semibold flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-sm md:text-base ${
                          addingToCart === selectedProductForAddons?.id
                            ...
                            : "bg-[#F18E02] text-white hover:bg-[#e08000] border border-[#F18E02]"
                        }`}
                      >
                        {addingToCart === selectedProductForAddons?.id ? (
                          <>
            ...
            >
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className="w-full h-40 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-[#F18E02] focus:border-transparent resize-none"
                  dir="rtl"
                  maxLength={500}
                  autoFocus
                />
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-[#F18E02] text-white rounded-lg font-semibold hover:shadow-lg transition-all flex items-center justify-center gap-2"
                >
      ...
      <div className="min-h-screen bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 font-sans relative overflow-x-hidden">
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-3 md:p-4 relative w-full border border-gray-200">
            <button
              ...
              className="absolute left-1 md:left-2 top-1/2 transform -translate-y-1/2 bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm rounded-full p-2 text-gray-600 dark:text-gray-300 hover:text-[#F18E02] z-10 shadow-lg border border-gray-300"
            >
              ...
              {categories.map((category) => (
                <button
                  ...
                  className={`flex-shrink-0 flex items-center gap-2 px-3 md:px-4 py-2 md:py-3 rounded-xl font-semibold text-sm md:text-base transition-all duration-300 ${
                    selectedCategory === category.id
                      ? "bg-[#F18E02] text-white shadow-lg border-2 border-[#F18E02]"
                ...
                >
                  ...
                  {category.id !== "all" &&
                    category.id !== "offers" &&
                    !category.isActive && (
                      <span className="text-xs text-[#F18E02]">(معطل)</span>
                    )}
                </button>
              ))}
            </div>
            ...
            <button
              ...
              className="absolute right-1 md:right-2 top-1/2 transform -translate-y-1/2 bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm rounded-full p-2 text-gray-600 dark:text-gray-300 hover:text-[#F18E02] z-10 shadow-lg border border-gray-300"
            >
        ...
        <div className="relative z-10 w-full">
          {productsLoading || !imagesLoaded ? (
            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-4 py-4 md:py-6 w-full">
              <div className="text-center py-12 md:py-16 bg-white dark:bg-gray-800 rounded-2xl shadow-lg mx-2 border border-gray-200">
                ...
                <button
                  ...
                  className="bg-[#F18E02] text-white px-6 py-3 rounded-xl font-semibold shadow-lg text-sm md:text-base hover:bg-[#e08000] transition-colors border border-[#F18E02]"
                >
                  عرض جميع المنتجات
                </button>
              </div>
              ...
              >
                {filteredProducts.map((product) => (
                  <div
                    ...
                    className={`bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 cursor-pointer w-full relative min-h-[180px] hover:shadow-xl transition-shadow duration-300 ${
                  ...
                  >
                    {product.itemOffer && product.itemOffer.isEnabled && (
                      <div className="absolute top-2 right-2 z-10">
                        <div className="bg-[#F18E02] text-white px-3 py-1.5 rounded-xl shadow-2xl flex items-center gap-1.5 border border-white">
                      ...
                      <div className="absolute top-2 left-2 z-10 flex flex-col gap-1">
                        ...
                        {canShowToggleButton && (
                          <button
                            ...
                            className={`p-2 rounded-lg shadow-lg text-xs no-product-details border ${
                        ...
                        {canShowAdminButtons && (
                          <>
                            <button
                              ...
                              className="bg-blue-500 text-white p-2 rounded-lg shadow-lg hover:bg-blue-600 no-product-details border border-blue-600"
                            >
                              <FaEdit size={12} />
                            </button>
                            <button
                              onClick={(e) => handleManageOffers(product, e)}
                              className="bg-purple-500 text-white p-2 rounded-lg shadow-lg hover:bg-purple-600 no-product-details border border-purple-600"
                            >
                              <FaPercent size={12} />
                            </button>
                            <button
                              ...
                              className="bg-red-500 text-white p-2 rounded-lg shadow-lg hover:bg-red-600 no-product-details border border-red-600"
                            >
                              <FaTrash size={12} />
                            </button>
                          </>
                    ...
                    <div className="sm:hidden">
                      <div className="p-3">
                        <div className="flex">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3
                              className="font-bold text-sm text-gray-800 dark:text-gray-200 hover:text-[#F18E02] line-clamp-1 mb-2"
                      ...
                      <div className="px-3 pb-3">
                        <div className="flex gap-2">
                          <button
                            ...
                            className={`flex-1 py-2.5 rounded-xl font-semibold flex items-center justify-center gap-2 text-xs no-product-details ${
                              addingToCart === product.id
                                ...
                                : isProductAvailableForCart(product)
                                  ? "bg-[#F18E02] text-white hover:bg-[#e08000]"
                          ...
                          <button
                            ...
                            className="flex-1 py-2.5 rounded-xl font-semibold flex items-center justify-center gap-2 text-xs no-product-details bg-gray-800 text-white hover:bg-gray-900 border border-gray-800"
                          >
                          ...
                          <button
                            ...
                            className={`p-2.5 rounded-xl font-semibold flex items-center justify-center text-xs no-product-details border ${
                              isProductInFavorites(product.id)
                                ? "text-[#F18E02] bg-orange-50 dark:bg-orange-900/20 hover:bg-orange-100 dark:hover:bg-orange-900/30 border-[#F18E02]"
                                : "text-gray-400 bg-gray-50 dark:bg-gray-700 hover:text-[#F18E02] hover:bg-gray-100 dark:hover:bg-gray-600 border-gray-300"
                            }`}
                          >
                            {isProductInFavorites(product.id) ? (
                              <FaHeart size={16} />
                    ...
                    <div className="hidden sm:block">
                      ...
                      <div className="p-3 sm:p-4">
                        <h3
                          className="font-bold text-base sm:text-lg text-gray-800 dark:text-gray-200 mb-2 hover:text-[#F18E02] line-clamp-1"
                          dir={isArabic(product.name) ? "rtl" : "ltr"}
                        >
                          {product.name}
                        </h3>
                        ...
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <button
                            ...
                            className={`p-2 rounded-full no-product-details border ${
                              isProductInFavorites(product.id)
                                ? "text-[#F18E02] bg-orange-50 dark:bg-orange-900/20 border-[#F18E02]"
                                : "text-gray-400 bg-gray-50 dark:bg-gray-700 hover:text-[#F18E02] border-gray-300"
                            }`}
                          >
                            {isProductInFavorites(product.id) ? (
                              <FaHeart size={18} />
                        ...
                        <div className="flex gap-2 mt-3 sm:mt-4">
                          ...
                          <button
                            ...
                            className="flex-1 py-2 sm:py-2.5 rounded-xl font-semibold flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-sm no-product-details bg-gray-800 text-white hover:bg-gray-900 border border-gray-800"
                          >
                          ...
                          {pageNum === "..." ? (
                            ...
                            <button
                              ...
                              className={`px-3 sm:px-4 py-1 sm:py-2 rounded-xl font-semibold border ${
                                currentPage === pageNum
                                  ? "bg-[#F18E02] text-white shadow-lg border-[#F18E02]"
                                  : "bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 border-gray-300 dark:border-gray-600"
                              }`}
                            >
                              {pageNum}
        ...
        {/* Cart Button */}
        <div
          className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-[#F18E02] text-white rounded-full p-3 sm:p-4 shadow-2xl z-40 cursor-pointer hover:scale-110 no-product-details border-2 border-white ${
        ...
        >
          <div className="relative">
            ...
            {cartItemsCount > 0 && (
              <span className="absolute -top-2 -right-2 bg-white text-[#F18E02] rounded-full w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center text-xs font-bold border border-[#F18E02]">
                {cartItemsCount}
              </span>
            )}
          </div>
        ...
        <div className="fixed bottom-4 left-4 flex flex-col gap-3 z-40">
          ...
          <button
            ...
            className="relative bg-[#F18E02] text-white rounded-full p-3 sm:p-4 shadow-2xl hover:scale-110 no-product-details border-2 border-white"
          >
            <div className="relative flex items-center justify-center">
              <FaHeart className="w-4 h-4 sm:w-6 sm:h-6" />

              {favorites.length > 0 && (
                <span className="absolute -top-2 -right-2 bg-white text-[#F18E02] rounded-full w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center text-xs font-bold shadow-md border border-[#F18E02]">
                  {favorites.length}
                </span>
              )}
            </div>
            ...
            <div className="absolute right-full mr-3 top-1/2 transform -translate-y-1/2 opacity-0 hover:opacity-100 pointer-events-none">
              <div className="bg-gray-900 text-white text-xs font-semibold px-3 py-2 rounded-lg shadow-lg whitespace-nowrap border border-gray-700">
                منتجاتي المفضلة
          ...
          {canShowAdminButtons && (
            <>
              <button
                ...
                className="relative bg-gray-800 text-white rounded-full p-3 sm:p-4 shadow-2xl hover:scale-110 no-product-details border-2 border-white"
              >
        ...
        {showCategoriesManager && canShowAdminButtons && (
          <>
            ...
            >
              <div
                className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl overflow-hidden w-full max-w-4xl mx-auto my-auto max-h-[90vh] overflow-y-auto border border-gray-300"
                onClick={(e) => e.stopPropagation()}
                dir="rtl"
              >
                <div className="bg-[#F18E02] text-white p-4 sm:p-6 relative border-b border-white">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={handleCloseCategoriesManager}
                      className="bg-white/20 backdrop-blur-sm rounded-full p-2 sm:p-3 text-white hover:bg-white/30 no-product-details border border-white"
                    >
                ...
                <div className="p-4 sm:p-6">
                  <div className="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-600 rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 shadow-lg">
                    <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                      <div className="bg-[#F18E02]/10 p-2 rounded-xl border border-[#F18E02]/20">
                        <FaPlus className="text-[#F18E02] text-base sm:text-lg" />
                      </div>
                      ...
                      <div className="lg:col-span-2">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className="w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-3 sm:py-4 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-600 dark:text-white focus:ring-2 focus:ring-[#F18E02] focus:border-[#F18E02] outline-none text-right text-base font-medium"
                          />
                        </div>
                      </div>
                        ...
                        <div className="flex items-center gap-3 sm:gap-4">
                          <label className="flex items-center cursor-pointer">
                            <div className="relative">
                              ...
                              />
                              <div
                                className={`block w-14 sm:w-16 h-7 sm:h-8 rounded-full border-2 ${
                              ...
                              ></div>
                              <div
                                className={`absolute right-1 top-1 bg-white w-5 sm:w-6 h-5 sm:h-6 rounded-full shadow-lg border border-gray-300 ${
                                  newCategory.isActive
                    ...
                    <div className="flex justify-start mt-4 sm:mt-6">
                      <button
                        ...
                        className="bg-[#F18E02] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-bold shadow-lg flex items-center gap-2 sm:gap-3 text-sm sm:text-base no-product-details hover:bg-[#e08000] border border-[#F18E02]"
                      >
                        <FaPlus />
                        إضافة تصنيف جديد
                      </button>
                  ...
                  <div>
                    <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                      <div className="bg-[#F18E02]/10 p-2 rounded-xl border border-[#F18E02]/20">
                        <FaList className="text-[#F18E02] text-base sm:text-lg" />
                      </div>
                      <h3 className="text-lg sm:text-xl font-bold text-gray-800 dark:text-gray-200">
                        ...
                        <div
                          ...
                          className={`bg-white dark:bg-gray-700 border-2 ${
                            category.id === "all" || category.id === "offers"
                              ...
                              : "border-gray-200 dark:border-gray-600 hover:border-[#F18E02]/50 dark:hover:border-[#F18E02]/50"
                            ...
                            <div className="space-y-4 sm:space-y-6">
                              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                                <div className="lg:col-span-2">
                                  ...
                                  <input
                                    ...
                                    className="w-full px-3 sm:px-4 py-3 sm:py-4 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-600 dark:text-white focus:ring-2 focus:ring-[#F18E02] focus:border-[#F18E02] outline-none text-right text-base font-medium"
                                    dir="rtl"
                                  />
                                </div>
                              ...
                              <div className="flex gap-2 sm:gap-3 justify-start pt-3 sm:pt-4 border-t border-gray-200 dark:border-gray-600">
                                ...
                                <button
                                  ...
                                  className="bg-[#F18E02] text-white px-4 sm:px-6 py-2 sm:py-3 rounded-xl font-bold shadow-lg flex items-center gap-2 text-sm sm:text-base no-product-details hover:bg-[#e08000] border border-[#F18E02]"
                                >
                                  <FaSave />
                                  حفظ التغييرات
                                </button>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                              <div className="flex items-center gap-3 sm:gap-4">
                                <div
                                  className={`p-2 sm:p-3 rounded-xl border ${
                                    category.id === "all"
                                      ? "bg-gray-100 dark:bg-gray-600 border-gray-300"
                                      : category.id === "offers"
                                  ...
                                  category.id !== "offers" && (
                                    <>
                                      <button
                                        ...
                                        className={`p-2 sm:p-3 rounded-xl shadow-md no-product-details border ${
                                          category.isActive
                                      ...
                                      <button
                                        ...
                                        className="bg-blue-500 text-white p-2 sm:p-3 rounded-xl hover:bg-blue-600 shadow-md no-product-details border border-blue-600"
                                        title="تعديل التصنيف"
                                      >
                                        <FaEdit
                                          size={16}
                                      ...
                                      <button
                                        ...
                                        className="bg-red-500 text-white p-2 sm:p-3 rounded-xl hover:bg-red-600 shadow-md no-product-details border border-red-600"
                                        title="حذف التصنيف"
                                      >
                                        <FaTrash
                                          size={16}
