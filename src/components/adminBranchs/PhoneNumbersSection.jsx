...
const PhoneNumbersSection = ({ phoneNumbers, setPhoneNumbers }) => {
  ...
  return (
    <div className="pt-2 sm:pt-3">
      ...
      <div className="bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 rounded-lg sm:rounded-xl p-3 sm:p-4 mb-3 sm:mb-4">
        <div className="grid grid-cols-1 gap-2 sm:gap-3">
          <div>
            ...
            <div className="relative group">
              <FaPhone className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-xs" />
              <input
                type="text"
                name="phone"
                value={phoneNumber.phone}
                onChange={handlePhoneInputChange}
                className="w-full border-2 border-gray-300 dark:border-gray-500 bg-white dark:bg-gray-600 text-black dark:text-white rounded-lg pr-9 pl-3 py-2 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-[#F18E02] transition-all duration-200 text-sm"
          ...
          <div>
            ...
            <div className="relative">
              <button
                ...
                className="w-full flex items-center justify-between border-2 border-gray-300 dark:border-gray-500 bg-white dark:bg-gray-600 text-black dark:text-white rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-[#F18E02] transition-all duration-200 text-sm"
              >
                <span className="flex items-center gap-2">
                  <FaPhone className="text-[#F18E02] text-xs" />
                ...
                >
                  <FaChevronDown className="text-[#F18E02] text-xs" />
                </motion.div>
              </button>
                  ...
                  >
                    {[
                      ...
                      <li
                        ...
                        className="px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-500 cursor-pointer text-gray-700 dark:text-gray-300 transition-all text-sm border-b border-gray-200 dark:border-gray-500 last:border-b-0 text-right"
                      >
                        {type.label}
                      </li>
                    ))}
          ...
          <div className="flex items-center justify-center gap-2 py-2">
            ...
            >
              <input
                ...
                className={`w-3 h-3 text-[#F18E02] bg-gray-100 border-gray-300 rounded focus:ring-[#F18E02] focus:ring-1 ${
                  phoneNumber.type !== "Mobile"
          ...
          <motion.button
            ...
            className={`py-2 rounded-lg font-semibold transition-all duration-300 text-sm flex items-center justify-center gap-2 border-2 ${
              phoneNumber.phone.trim()
                ? "bg-[#F18E02] text-white hover:bg-[#be6f00] border-[#F18E02]"
          ...
          {phoneNumbers.map((phone, index) => (
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 flex-1">
                <FaPhone className="text-[#F18E02] text-xs sm:text-sm" />
