    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 lg:p-6 border-2 border-gray-300 shadow-lg sticky top-4 sm:top-6">
        <div className="flex items-center justify-between mb-3 sm:mb-4">
          ...
          <button
            onClick={onCancel}
            className="text-gray-500 dark:text-gray-400 hover:text-[#F18E02] transition-colors duration-200 flex-shrink-0 ml-2"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          <div>
            ...
            <div className="relative group">
              <FaBuilding className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm transition-all duration-300 group-focus-within:scale-110" />
              <input
                type="text"
                name="name"
                value={formData.name}
                ...
                required
                className="w-full border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-600 text-black dark:text-white rounded-lg sm:rounded-xl pr-9 pl-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-[#F18E02] transition-all duration-200 text-sm sm:text-base"
          ...
          <div>
            ...
            <div className="relative group">
              <FaEnvelope className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm transition-all duration-300 group-focus-within:scale-110" />
              <input
                type="email"
                name="email"
          ...
          <div>
            ...
            <div className="relative group">
              <FaMapMarkerAlt className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm transition-all duration-300 group-focus-within:scale-110" />
              <input
                type="text"
                name="address"
          ...
          <div>
            ...
            <div className="relative group">
              <FaGlobe className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm transition-all duration-300 group-focus-within:scale-110" />
              <input
                type="url"
                name="locationUrl"
            ...
            <div>
              ...
              <div className="relative">
                <button
                  ...
                  className="w-full flex items-center justify-between border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-600 text-black dark:text-white rounded-lg sm:rounded-xl px-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#F18E02] focus:border-[#F18E02] transition-all duration-200 text-sm sm:text-base"
                >
                  <span className="flex items-center gap-2">
                    <FaCity className="text-[#F18E02]" />
                    {formData.cityId
          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
            <div>
              ...
              <div className="relative group">
                <FaClock className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#F18E02] text-sm transition-all duration-300 group-focus-within:scale-110" />
                <input
                  type="time"
                  name="openingTime"
          ...
          <div className="flex gap-2 sm:gap-3 pt-1 sm:pt-2">
            ...
            <motion.button
              ...
              className={`flex-1 py-2.5 sm:py-3 rounded-lg sm:rounded-xl font-semibold transition-all duration-300 text-sm sm:text-base flex items-center justify-center gap-1 sm:gap-2 ${
                isFormValid()
                  ? "bg-[#F18E02] text-white hover:bg-[#be6f00] hover:shadow-xl hover:shadow-[#F18E02]/25 border-2 border-[#F18E02]"
