  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <div className="absolute inset-0 animate-ping rounded-full h-16 w-16 border-t-4 border-b-4 border-[#F18E02] opacity-30"></div>
      </div>
      ...
      <motion.button
        ...
        className={`w-full font-semibold py-3.5 rounded-xl transition-all duration-300 text-lg relative overflow-hidden border ${
          resendDisabled
            ...
            : "bg-[#F18E02] text-white hover:shadow-xl hover:shadow-[#F18E02]/25 border-[#F18E02] hover:bg-[#be6f00]"
        }`}
      >
        {resendDisabled
      ...
      <button
        ...
        className="text-[#F18E02] hover:text-[#be6f00] underline font-medium transition-colors duration-200 text-sm"
      >
