    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm flex flex-col justify-center items-center z-50"
          dir="rtl"
        >
          <motion.div
          ...
          >
            ...
            <div className="bg-[#F18E02] p-6 text-center">
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
            ...
            <div className="p-8 space-y-6 text-center">
              ...
              >
                <div className="flex items-center justify-center gap-3 text-lg font-semibold text-gray-700 dark:text-gray-300">
                  ...
                  >
                    <FaCheckCircle className="text-[#F18E02]" size={24} />
                  </motion.div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="h-1 bg-gradient-to-r from-[#F18E02] to-[#F18E02]/70 rounded-full"
              />
            </div>
          </motion.div>
          ...
          <div className="absolute inset-0 -z-10 overflow-hidden">
            <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-gradient-to-r from-[#F18E02]/5 to-[#F18E02]/10 rounded-full blur-3xl"></div>
            <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-gradient-to-r from-[#F18E02]/10 to-[#F18E02]/5 rounded-full blur-3xl"></div>
          </div>
        </motion.div>
      )}
    </AnimatePresence>
