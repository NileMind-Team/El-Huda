...
export default function AuthLayout({
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-[#fff8f0] to-[#fff0e0] dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 px-4 relative font-sans overflow-hidden transition-colors duration-300`}
      dir="rtl"
    >
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -left-20 -top-20 w-80 h-80 bg-gradient-to-r from-[#F18E02]/10 to-[#be6f00]/10 dark:from-[#F18E02]/20 dark:to-[#be6f00]/20 rounded-full blur-3xl"></div>
        <div className="absolute -right-20 -bottom-20 w-80 h-80 bg-gradient-to-r from-[#be6f00]/10 to-[#F18E02]/10 dark:from-[#be6f00]/20 dark:to-[#F18E02]/20 rounded-full blur-3xl"></div>
      </div>

      {!showWelcome && !isProcessingGoogle && (
        <button
          onClick={onBack}
          className="fixed top-6 left-6 z-50 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md hover:bg-[#F18E02] hover:text-white rounded-full p-3 text-[#F18E02] dark:text-gray-300 border border-[#F18E02] dark:border-gray-600 shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-xl"
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-[#F18E02]/5 to-transparent rounded-tr-3xl"></div>
            ...
            >
              ...
              <div className="space-y-6 mb-8">
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white leading-tight text-right">
                  مرحباً بك في
                  <br />
                  <span className="text-[#F18E02] block mt-2">El-Huda</span>
                </h1>
              ...
              <div className="flex flex-col gap-3 flex-1 justify-center">
                <motion.button
                  ...
                  className={`flex items-center gap-4 px-6 py-4 rounded-xl font-semibold text-lg transition-all duration-300 border ${
                    activeTab === "login"
                      ? "bg-white dark:bg-gray-800 text-[#F18E02] shadow-lg border-[#F18E02]"
                      : "text-gray-600 dark:text-gray-400 hover:text-[#F18E02] hover:bg-white/50 dark:hover:bg-gray-700/50 border-gray-300 dark:border-gray-600 hover:border-[#F18E02]/50"
                  }`}
                >
                  <div
