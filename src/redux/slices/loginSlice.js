...
const loginSlice = createSlice({
  ...
  initialState: {
    ...
    isFacebookCallbackProcessing: false,
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(loginWithFacebook.pending, (state) => {
        state.isFacebookLoading = true;
        state.error = null;
      })
      .addCase(loginWithFacebook.fulfilled, (state) => {
        state.isFacebookLoading = false;
      })
      .addCase(loginWithFacebook.rejected, (state, action) => {
        ...
        Swal.fire({
          icon: "error",
          title: "خطأ في تسجيل الدخول بـ Facebook",
          text: action.payload?.message || "حدث خطأ أثناء الاتصال بـ Facebook",
        });
      })
      ...
      .addCase(handleFacebookCallback.pending, (state) => {
        state.isLoading = true;
        state.isFacebookCallbackProcessing = true;
        state.error = null;
      })
      .addCase(handleFacebookCallback.fulfilled, (state, action) => {
        state.isLoading = false;
        state.isFacebookCallbackProcessing = false;
        const data = action.payload;
...
export const { logout, clearError, setGoogleLoading, setFacebookLoading } =
  loginSlice.actions;
